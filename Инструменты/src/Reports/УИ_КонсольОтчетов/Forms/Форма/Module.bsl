...
&НаКлиенте
Процедура ВнешниеНаборыДанныхЗначениеНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	СтандартнаяОбработка=Ложь;
	УИ_ОбщегоНазначенияКлиент.РедактироватьТаблицуЗначений(ТЗСтрокой(), ЭтотОбъект,
		Новый ОписаниеОповещения("ВнешниеНаборыДанныхЗначениеНачалоВыбораЗавершение", ЭтотОбъект));
КонецПроцедуры
&НаКлиенте
Процедура ВнешниеНаборыДанныхЗначениеНачалоВыбораЗавершение(Результат, ДополнительныеПараметры) Экспорт
