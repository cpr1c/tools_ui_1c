...
Процедура ИзменитьВариант(Команда)
	ПараметрыФормы=Новый Структура("Вариант, АдресСхемыИсполненногоОтчета", Отчет.КомпоновщикНастроек.Настройки,АдресСхемыИсполненногоОтчета);

	ОписаниеОповещенияОЗакрытии=Новый ОписаниеОповещения("ИзменитьВариантЗавершение", ЭтотОбъект);
	ОткрытьФорму("Отчет.УИ_КонсольОтчетов.Форма.ФормаВарианта",ПараметрыФормы,ЭтотОбъект,,,,ОписаниеОповещенияОЗакрытии,РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);
КонецПроцедуры
