...
Процедура КомандаВыгрузитьРезультатВФайлНаКлиентеЗавершение(ВыбранныеФайлы, ДополнительныеПараметры) Экспорт
	...
	Если (ВыбранныеФайлы <> Неопределено) Тогда
		...
		ДанныеФайла.НачатьЗапись(Новый ОписаниеОповещения("КомандаВыгрузитьРезультатВФайлНаКлиентеЗавершениеЗаписиФайла",ЭтотОбъект,Новый Структура("ПолноеИмяФайла",ДиалогСохраненияФайла.ПолноеИмяФайла)),ДиалогСохраненияФайла.ПолноеИмяФайла);
...
Процедура КомандаВыгрузитьРезультатВФайлНаКлиентеЗавершениеЗаписиФайла(ДополнительныеПараметры) Экспорт
	Сообщить(Формат(ТекущаяДата(),"ДФ='yyyy.MM.dd HH.mm.ss'") + ": формирование файла завершено (" + ДополнительныеПараметры.ПолноеИмяФайла + ")");
КонецПроцедуры
...
Процедура СохранитьНастройкиВФайлНаКлиенте()
	...
	ДиалогВыбора.Показать(Новый ОписаниеОповещения("СохранитьНастройкиВФайлНаКлиентеЗавершение", ЭтаФорма, Новый Структура("ДиалогВыбора", ДиалогВыбора)));
...
Процедура СохранитьНастройкиВФайлНаКлиентеЗавершение(ВыбранныеФайлы, ДополнительныеПараметры) Экспорт
	...
	Если (ВыбранныеФайлы <> Неопределено) Тогда
		...
		ДвоичныеДанные.НачатьЗапись(Новый ОписаниеОповещения("СохранитьНастройкиВФайлНаКлиентеЗавершениеЗаписиФайла",ЭтотОбъект),ДиалогВыбора.ПолноеИмяФайла);
...
Процедура ОткрытьНастройкиИзФайлаНаКлиенте(Знач Оповещение)
	...
	ДиалогВыбора.Показать(Новый ОписаниеОповещения("ОткрытьНастройкиИзФайлаНаКлиентеЗавершение", ЭтаФорма, Новый Структура("ДиалогВыбора, Оповещение", ДиалогВыбора, Оповещение)));
...
Процедура ОткрытьФормуВыбораОперацииДляЗаписи()
	...
	ОткрытьФорму("Справочник.ВС_ОперацииСравненияДанных.ФормаВыбора",,,,,, Новый ОписаниеОповещения("СохранитьВВыбраннуюОперациюЗавершение", ЭтаФорма), РежимОткрытияОкнаФормы.БлокироватьВесьИнтерфейс);
...
Процедура СохранитьНастройкиВБазу(Команда)
	...
	Если ЗначениеЗаполнено(Объект.СвязаннаяОперацияСравненияДанных)  Тогда
		...
		ПоказатьВопрос(Новый ОписаниеОповещения("СохранитьВСвязаннуюОперациюЗавершение", ЭтотОбъект, Истина), "Обновить элемент справочника """ + Объект.СвязаннаяОперацияСравненияДанных + """?", РежимДиалогаВопрос.ДаНет);
...
Процедура ПриЗакрытии(ЗавершениеРаботы)
	...
	Если ЗначениеЗаполнено(Объект.СвязаннаяОперацияСравненияДанных) И Не Объект.ПользовательскийРежим  Тогда
		...
		ПоказатьВопрос(Новый ОписаниеОповещения("СохранитьВСвязаннуюОперациюЗавершение", ЭтотОбъект, Ложь), "Обновить элемент справочника """ + Объект.СвязаннаяОперацияСравненияДанных + """?", РежимДиалогаВопрос.ДаНет);
