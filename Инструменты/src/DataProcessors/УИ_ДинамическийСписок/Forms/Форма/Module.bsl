...
// Соберём доступные виды объектов в дерево
	...
	ДобавитьВДеревоВидОбъекта(БиблиотекаКартинок.РегистрСведений, "РегистрыСведений", "РегистрСведений", "Регистры сведений");
	ДобавитьВДеревоВидОбъекта(БиблиотекаКартинок.РегистрНакопления, "РегистрыНакопления", "РегистрНакопления", "Регистры накопления");
	ДобавитьВДеревоВидОбъекта(БиблиотекаКартинок.РегистрРасчета, "РегистрыРасчета", "РегистрРасчета", "Регистры расчета");
	ДобавитьВДеревоВидОбъекта(БиблиотекаКартинок.РегистрБухгалтерии, "РегистрыБухгалтерии", "РегистрБухгалтерии", "Регистры бухгалтерии");
...
Процедура ДобавитьВДеревоВидОбъекта(Картинка, ИмяТипаМетаданных,
	...
	Для каждого мдОбъекта из Метаданные[ИмяТипаМетаданных] Цикл
		...
		Если УИ_ОбщегоНазначения.ЭтоРегистрСведений(мдОбъекта)
			ИЛИ УИ_ОбщегоНазначения.ЭтоРегистрНакопления(мдОбъекта)
			ИЛИ УИ_ОбщегоНазначения.ЭтоРегистрРасчета(мдОбъекта)
			ИЛИ УИ_ОбщегоНазначения.ЭтоРегистрБухгалтерии(мдОбъекта) Тогда
			МассивТаблицРеквизитов.Добавить(мдОбъекта.Измерения);	
			МассивТаблицРеквизитов.Добавить(мдОбъекта.Ресурсы);	
		КонецЕсли;
