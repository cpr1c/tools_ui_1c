...
Процедура ДобавитьРеквизитВКоллекциюРеквизитов(КоллекцияРеквизитов, Имя, Тип,
		Заголовок, ИмяРеквизитаФормы, ГруппаРеквизитов = "Реквизиты",
...
&НаСервере
Процедура ДобавитьРеквизитКДобавлениюНаФорму(КоллекцияРеквизитов, ТекРеквизитМетаданных,
		ПрефиксИмениФормы, МассивДобавляемыхРеквизитов, ГруппаРеквизитов,
	...
	ДобавитьРеквизитВКоллекциюРеквизитов(КоллекцияРеквизитов, ТекРеквизитМетаданных.Имя, ТекРеквизитМетаданных.Тип, Синоним, ИмяРеквизита, ГруппаРеквизитов, ПредставлениеГруппыРеквизитов);
...
Процедура ДобавитьСтандартныеРеквизитыМетаданногоКДобавлениюНаФорму(МетаданныеОбъекта,
	...
	Для Каждого ТекРеквизит Из МетаданныеОбъекта.СтандартныеРеквизиты Цикл
		ДобавитьРеквизитКДобавлениюНаФорму(РеквизитыОбъекта.Реквизиты, ТекРеквизит, "СтандартныйРеквизит_", МассивДобавляемыхРеквизитов, "СтандартныеРеквизиты", "Стандартные реквизиты");
	КонецЦикла;
...
Процедура ДобавитьРеквизитыМетаданногоКДобавлениюНаФорму(МетаданныеОбъекта,
	...
	Для Каждого ТекРеквизит Из МетаданныеОбъекта.Реквизиты Цикл
		ДобавитьРеквизитКДобавлениюНаФорму(РеквизитыОбъекта.Реквизиты, ТекРеквизит, "Реквизит_", МассивДобавляемыхРеквизитов, "Реквизиты", "Реквизиты");
	КонецЦикла;
...
Процедура ДобавитьСпецифичныеРеквизитыПланаСчетовКДобавлениюНаФорму(МетаданныеОбъекта,
	...
	Для Каждого ТекРеквизит Из МетаданныеОбъекта.ПризнакиУчета Цикл
		ДобавитьРеквизитКДобавлениюНаФорму(РеквизитыОбъекта.Реквизиты, ТекРеквизит, "ПризнакУчета_", МассивДобавляемыхРеквизитов, "ПризнакиУчета", "Признаки учета");
	КонецЦикла;
...
Процедура ДобавитьСпецифичныеРеквизитыЗадачиКДобавлениюНаФорму(МетаданныеОбъекта,
	...
	Для Каждого ТекРеквизит Из МетаданныеОбъекта.РеквизитыАдресации Цикл
		ДобавитьРеквизитКДобавлениюНаФорму(РеквизитыОбъекта.Реквизиты, ТекРеквизит, "РеквизитАдресации_", МассивДобавляемыхРеквизитов, "РеквизитыАдресации", "Реквизиты адресации");
	КонецЦикла;
...
Процедура ДобавитьРеквизитыТабличныхЧастейВРеквизитыФормы(МетаданныеОбъекта)
	...
	Для Каждого ОписаниеТабличнойЧасти Из РеквизитыОбъекта.ТабличныеЧасти Цикл
		...
		Для Каждого Реквизит Из ТабличнаяЧасть.СтандартныеРеквизиты Цикл
			ДобавитьРеквизитКДобавлениюНаФорму(ОписаниеТабличнойЧасти.Реквизиты, Реквизит, "", МассивДобавляемыхРеквизитов, "Реквизиты", "Реквизиты", ОписаниеТабличнойЧасти.ИмяРеквизитаФормы);
		КонецЦикла;
		...
		Если УИ_ОбщегоНазначения.ЭтоПланСчетов(МетаданныеОбъекта) Тогда
			Для Каждого ПризнакУчетаСубконто Из МетаданныеОбъекта.ПризнакиУчетаСубконто Цикл
				ДобавитьРеквизитКДобавлениюНаФорму(ОписаниеТабличнойЧасти.Реквизиты, ПризнакУчетаСубконто, "", МассивДобавляемыхРеквизитов, "Реквизиты", "Реквизиты", ОписаниеТабличнойЧасти.ИмяРеквизитаФормы);
			КонецЦикла;
		КонецЕсли;
