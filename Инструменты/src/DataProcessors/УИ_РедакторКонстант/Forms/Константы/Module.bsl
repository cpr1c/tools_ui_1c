...
Процедура ПоказыватьСинонимПриИзменении(Элемент)
	Для Каждого ТекКонстанта ИЗ ТаблицаКонстант Цикл
		Элементы["Заголовок_" + ТекКонстанта.ИмяКонстанты].Заголовок=ЗаголовокЭлементаКонстанты(ТекКонстанта.ИмяКонстанты, ТекКонстанта.СинонимКонстанты, ПоказыватьСиноним, НРег(СокрЛП(СтрокаПоиска)));
	КонецЦикла;
КонецПроцедуры
