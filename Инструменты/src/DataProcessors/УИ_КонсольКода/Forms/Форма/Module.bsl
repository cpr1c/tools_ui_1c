...
Процедура НовыйАлгоритм(Команда)
	...
	Если УИ_ОбщегоНазначенияКлиентСервер.ПолеHTMLПостроеноНаWebkit() Тогда
		УИ_РедакторКодаКлиентСервер.УстановитьТекстРедактораЭлемента(Элементы.ПолеАлгоритмаКлиент, ТекстАлгоритмаКлиент);
		УИ_РедакторКодаКлиентСервер.УстановитьТекстРедактораЭлемента(Элементы.ПолеАлгоритмаСервер, ТекстАлгоритмаСервер);
	КонецЕсли;
