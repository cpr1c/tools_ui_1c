...
Процедура ПриОткрытии(Отказ)
	...
	мФормаПараметров = ПолучитьФорму("Обработка.УИ_КонсольЗапросов.Форма.ФормаПараметров", Неопределено, ЭтаФорма);
...
Процедура ПараметрыТаблицаЗначениеПараметраНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	Если текДанные.Тип = "Таблица" Тогда
		СтандартнаяОбработка = Ложь;
		формаРедактирования = ПолучитьФорму("Обработка.УИ_КонсольЗапросов.Форма.ФормаВложеннойТаблицы",Неопределено, ВладелецФормы);
