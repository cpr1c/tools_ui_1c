...
&НаКлиенте
Процедура ПараметрыТаблицаЗначениеПараметраНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	текДанные = Элементы.ПараметрыТаблица.ТекущиеДанные;
...
Функция КаталогБекаповЗапросов()
	Возврат КаталогВременныхФайлов()+ПолучитьРазделительПути()+"УИ"+ПолучитьРазделительПути()+"КонсольЗапросов"+ПолучитьРазделительПути();
КонецФункции
