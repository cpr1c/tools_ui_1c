...
Процедура РазвернутьСвернутьПолеПросмотраНаВсюФорму(Команда)
	...
	Если ПолеПросмотраРазвернутоНаВсюФорму Тогда
		...
		СохраненныеЗначенияРедаторов.Вставить("РедакторРезультирующегоHTML", ТекстРедактораЭлемента(
		...
		СохраненныеЗначенияРедаторов.Вставить("РедакторСобытияДокументСформирован", ТекстРедактораЭлемента(
			Элементы.РедакторСобытияДокументСформирован));
		СохраненныеЗначенияРедаторов.Вставить("РедакторСобытияПриНажатии", ТекстРедактораЭлемента(
...
Процедура ПриОткрытииЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	РедакторHTML=УИ_РедакторКодаКлиент.ИмяФайлаРедактораДляЯзыка("html");
