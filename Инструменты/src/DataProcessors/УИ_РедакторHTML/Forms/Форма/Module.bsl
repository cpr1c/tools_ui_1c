...
Процедура ПриОткрытииЗавершение(Результат, ДополнительныеПараметры) Экспорт
	...
	РедакторJS=УИ_РедакторКодаКлиент.ТекстHTMLРедактораКода("javascript");
	РедакторCSS=УИ_РедакторКодаКлиент.ТекстHTMLРедактораКода("css");
	РедакторHTML=УИ_РедакторКодаКлиент.ТекстHTMLРедактораКода("html");
	РедакторРезультирующегоHTML=УИ_РедакторКодаКлиент.ТекстHTMLРедактораКода("html");
	РедакторСобытияДокументСформирован=УИ_РедакторКодаКлиент.ТекстHTMLРедактораКода("bsl");
	РедакторСобытияПриНажатии=УИ_РедакторКодаКлиент.ТекстHTMLРедактораКода("bsl");
