...
// 											Если не параметр не указан, сравнение происходит по колонка базовой таблицы
// 	
// 	
// Возвращаемое значение:
// 
...
Функция _ТЗСр(ТаблицаБазовая, ТаблицаСравнения, СписокКолонок=Неопределено) Экспорт
	...
	Возврат УИ_ОбщегоНазначенияВызовСервера.ВыполнитьСравнениеДвухТаблицЗначений(ТаблицаБазовая, ТаблицаСравнения, КолонкиДляСравнения);
КонецФункции
