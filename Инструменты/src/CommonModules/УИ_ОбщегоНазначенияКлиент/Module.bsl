...
Процедура ОткрытьФормуВыбораЭлементовСпискаЗначений(Список, ОписаниеОповещенияОЗакрытии, Заголовок = "", ВозвращатьТолькоВыбранныеЗначения=Истина,
	РежимОткрытия = Неопределено) Экспорт
	ПараметрыФормы = Новый Структура;
	...
	Если РежимОткрытия = Неопределено Тогда
		ОткрытьФорму("ОбщаяФорма.УИ_ФормаВыбораЭлементовСпискаЗначений", ПараметрыФормы, , , , , ОписаниеОповещенияОЗакрытии);
	Иначе
		ОткрытьФорму("ОбщаяФорма.УИ_ФормаВыбораЭлементовСпискаЗначений", ПараметрыФормы, , , , , ОписаниеОповещенияОЗакрытии,
			РежимОткрытия);
	КонецЕсли;
