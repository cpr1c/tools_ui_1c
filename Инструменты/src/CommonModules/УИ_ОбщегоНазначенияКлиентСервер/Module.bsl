...
Функция ПараметрыЗаписиФормы(Форма) Экспорт
...
Процедура УстановитьПараметрыЗаписиНаФорму(Форма,ПараметрыЗаписи) Экспорт
	ЗаполнитьЗначенияСвойств(Форма, ПараметрыЗаписи);
КонецПроцедуры
