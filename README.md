...
- **Навигатор по метаданным**- Обработка замена стандартному меню "Все функции". Здесь же дополнительные административные функции будут. Форк https://infostart.ru/public/931586/. [Разрешение автора](http://forum.infostart.ru/forum9/topic202659/message2375904/#message2375904)
...
- **Редактор временного хранилища** — Инструмент просмотра и правки данных временного хранилища 1С, а также помещения новый данных во временное хранилище. 
