...
Процедура ВыполнитьСборкуИсходников() Экспорт
	...
	Сообщить (СвойстваКонфигурацииОсновногоРасширения["Synonym"]);
		СвойстваКонфигурацииОсновногоРасширения["Synonym"][0]["v8:item"]["v8:content"] = СвойстваКонфигурацииОсновногоРасширения["Synonym"][0]["v8:item"]["v8:content"] + " " + ВариантСборки.СуффиксСинонима;
	КонецЕсли;
