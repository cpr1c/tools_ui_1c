...
Процедура СкопироватьИсходныеФайлыДляКонвертации()
	...
	КаталогГлавнойОбработки = ОбъединитьПути(СтруктураПортативныхИнструментов.КаталогИсходников, "PortableToolsInternational");
	
	КаталогИсходныхФайловГлавнойОбработки = ОбъединитьПути(КаталогИсходныхФайловРасширения, "PortableToolsInternational", "ExternalDataProcessors");
