...
#Область СдужебныйПрограммныйИнтерфейс
...
// Определяет, является ли регистр сведений периодическим.
// Проверяет периодичность только для регистров сведений, сравнивая с непериодическим режимом.
//
// Параметры:
//   ВидОбъекта - Строка - тип объекта метаданных
//   ОбъектМетаданных - ОбъектМетаданных - объект метаданных
//
// Возвращаемое значение:
//   Булево - Истина, если регистр сведений является периодическим
//
