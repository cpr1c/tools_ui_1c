...
Процедура ЗагрузитьСхемуИзФайла(Команда)
	...
	НачатьПодключениеРасширенияРаботыСФайлами(
		Новый ОписаниеОповещения("ЗагрузитьСхемуИзФайлаПослеПодключенияРасширения", ЭтотОбъект, Новый Структура("Адрес",
		Адрес)));
КонецПроцедуры
...
Процедура СохранитьСхемуВФайлПослеПодключенияРасширения(Подключено, ДополнительныеПараметры) Экспорт
	...
	// Нужно запросить имя файла.
		...
		ВыборФайла.Показать(Новый ОписаниеОповещения("СохранитьСхемуВФайлПослеВыбораФайла", ЭтотОбъект,
...
Процедура ЗагрузитьСхемуИзФайлаПослеПодключенияРасширения(Подключено, ДополнительныеПараметры) Экспорт
	...
	Иначе
		...
		НачатьПомещениеФайла(Новый ОписаниеОповещения("ЗагрузитьСхемуИзФайлаПослеПомещенияФайла", ЭтотОбъект,
