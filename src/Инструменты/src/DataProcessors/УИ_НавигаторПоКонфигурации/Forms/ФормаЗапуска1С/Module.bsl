...
// Метод закомментирован для корректной сборки УИ инструментов
...
Процедура ПриОткрытии(Отказ)
	...
	Поз = СтрНайти(Папка1С, пРазделительПути, НаправлениеПоиска.СКонца,, 3);
	Если Поз <> 0 Тогда
...
Функция вКаталогФайла(ПолноеИмяФайла)
	...
	Поз = СтрНайти(ПолноеИмяФайла, пРазделительПути, НаправлениеПоиска.СКонца,, 1);
	Если Поз = 0 Тогда
