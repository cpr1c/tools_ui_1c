...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Заголовок = НСтр("ru = 'Редактор движений'");
...
Процедура ОбработкаВыбора(ВыбранноеЗначение, ИсточникВыбора)
	...
	// Замена открытие формы динамического списка на обработку УИ
	Если ТипЗнч(ИсточникВыбора) = Тип("ФормаКлиентскогоПриложения") и СтрНайти(ИсточникВыбора.ИмяФормы, "УИ_ДинамическийСписок.Форма") <> 0 Тогда
