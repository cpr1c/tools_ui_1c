...
Процедура СоздатьРеквизитыТаблицыПоКолонкам(Форма, ИмяРеквизитаТаблицыФормы, ИмяРеквизитаСоответствияКолонок,
	...
	Если Колонки <> Неопределено Тогда
		...
		Для Каждого Колонка Из Колонки Цикл
			...
			Если фЕстьНеотображаемыеТипы Тогда
				...
				Реквизит = Новый РеквизитФормы(стрИмяКолонкиКонтейнера, Новый ОписаниеТипов, ИмяРеквизитаТаблицыФормы,
					стрИмяКолонкиКонтейнера);
	...
	Если Колонки <> Неопределено Тогда
		...
		Для Каждого Колонка Из Колонки Цикл
			...
			КолонкаТаблицы = Форма.Элементы.Добавить(стрИмяКолонки, Тип("ПолеФормы"),
