...
&НаСервере
Процедура ПриСозданииНаСервереВнешнийИсточникДанных(Параметры)
	Если Параметры.ВнешнийИсточникДанных Тогда
		Элементы.ДобавитьВПараметр.Видимость = Истина;
		Элементы.Документ.Редактирование = Истина;
	КонецЕсли;	
КонецПроцедуры
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	Если Параметры.Свойство("ВнешнийИсточникДанных") Тогда
		ПриСозданииНаСервереВнешнийИсточникДанных(Параметры);	
	Иначе	
...
&НаКлиенте
Процедура ДобавитьВПараметр(Команда)
...
Функция ПолучитьДанныеТабличногоДокументаВВидеМассива()
	...
	Попытка
		...
		Построитель.ИсточникДанных = Новый ОписаниеИсточникаДанных(Документ.Область());  	
