...
Функция ХранилищеОписанияТиповСтрокиПараметра(ДанныеСтроки)
	СтруктураХранения = УИ_ОбщегоНазначенияКлиентСервер.НовыйСтруктураХраненияРеквизитаНаФормеСКонейнером("ТипЗначения");
...
Процедура ПараметрыЗапросаТипЗначенияПриИзмененииНаСервере(ИдентификаторСтроки)
	...
	СтруктураХраненияТипа = УИ_ОбщегоНазначенияКлиентСервер.НовыйСтруктураХраненияРеквизитаНаФормеСКонейнером("ТипЗначения");
...
Функция ПараметрыЗаполнитьИзЗапросаНаСервере(ТекущийТекстЗапроса)
	...
	Для Каждого Параметр Из НайденныеПараметры Цикл
		...
		СтруктураХраненияТипаЗначения = УИ_ОбщегоНазначенияКлиентСервер.НовыйСтруктураХраненияРеквизитаНаФормеСКонейнером("ТипЗначения");
