...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ОбъектОбработки.ОбработкаВходитВСоставУниверсальныхИнструментов() Тогда
		Объект.Заголовок="";
		Заголовок="";
...
Процедура РезультатЗапросаВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	Если РезультатЗапросаКолонкиКонтейнера.Свойство(ИмяКолонки) Тогда
		...
		Контейнер = ЭтаФорма[Элемент.Имя].НайтиПоИдентификатору(Элемент.ТекущаяСтрока)[ИмяКолонки + СуффиксРеквизитаКонтейнера];
...
Процедура УИ_РедактироватьЗначение(Команда)
	...
	Если ЗначениеКолонки="<ХранилищеЗначения>" Тогда
		Выполнить("УИ_ОбщегоНазначенияКлиент.РедактироватьХранилищеЗначения(ЭтотОбъект, ТекДанные[ИмяКолонки+СуффиксРеквизитаКонтейнера].Хранилище);");
	Иначе
		Выполнить("УИ_ОбщегоНазначенияКлиент.РедактироватьОбъект(ЗначениеКолонки);");
	КонецЕсли;
