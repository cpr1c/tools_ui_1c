...
Функция ПакетЗапросов_ЗагрузитьНаСервере(Знач стрЗагруженныеДанные)
	сообщить("начальная длинна: "+СтрДлина(стрЗагруженныеДанные));
...
//			
//			Результат = СтрНайтиПоРегулярномуВыражению(стрЗагруженныеДанные, Паттерн, , , , , Истина);
//			Если Не ПустаяСтрока(Результат.Значение) Тогда
//				стрЗагруженныеДанные = СтрЗаменить(стрЗагруженныеДанные, Результат.Значение, ""); 
//			КонецЕсли;
	...
	КонецЦикла;
	Чтение.Закрыть();
	сообщить("конечная длинна: "+СтрДлина(стрЗагруженныеДанные));
