...
&НаКлиенте
Перем УИ_РазворачиваемыеСтроки; //Массив
...
#КонецЕсли
	...
	УИ_РазворачиваемыеСтроки = Новый Массив;
КонецПроцедуры
...
Процедура СтруктураЗаписиРезультатаПередРазворачиванием(Элемент, Строка, Отказ)
	...
	Если Не СтрокаДерева.ПодчиненныеУзлыРаскрыты Тогда
		УИ_РазворачиваемыеСтроки.Добавить(Строка);
		
		ПодключитьОбработчикОжидания("СтруктураЗаписиРезультатаПередРазворачиванием_ОтложеннаяОбработка", 0.1, Истина);
	КонецЕсли;

КонецПроцедуры

&НаКлиенте
Процедура СтруктураЗаписиРезультатаПередРазворачиванием_ОтложеннаяОбработка()
	Для Каждого Строка Из УИ_РазворачиваемыеСтроки Цикл
