...
Процедура Команда_ФорматироватьТекстЗапроса(Команда)
	...
	ТекстКоличество.УстановитьТекст(ТекущийТекстЗапроса());
	УстановитьГраницыВыделенияЗапроса(1, 1, ТекстКоличество.КоличествоСтрок() + 1, 1);
	ВставитьТекстПоПозицииКурсораЗапроса(Результат);
	ПоместитьРедактируемыйЗапрос();
	Модифицированность = Истина;
