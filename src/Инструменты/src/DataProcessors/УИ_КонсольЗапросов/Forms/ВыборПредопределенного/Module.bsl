...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ЗначениеЗаполнено(Параметры.ТекстЗапроса) Тогда
		...
		СтрокаФиктивногоПараметра = Лев(НачальнаяСтрока, Параметры.НачальнаяКолонка - 1) + "&" + ИмяФиктивногоПараметры
			+ Прав(КонечнаяСтрока, СтрДлина(КонечнаяСтрока) - Параметры.КонечнаяКолонка);
...
Функция ТипДляЗапроса(НазваниеТипаВМетаданных)
	Если НазваниеТипаВМетаданных = "Справочники" Тогда
		Возврат "Справочник";
	ИначеЕсли НазваниеТипаВМетаданных = "Перечисления" Тогда
		Возврат "Перечисление";
	ИначеЕсли НазваниеТипаВМетаданных = "ПланыВидовХарактеристик" Тогда
		Возврат "ПланВидовХарактеристик";
	ИначеЕсли НазваниеТипаВМетаданных = "ПланыСчетов" Тогда
		Возврат "ПланСчетов";
	ИначеЕсли НазваниеТипаВМетаданных = "ПланыВидовРасчета" Тогда
		Возврат "ПланВидовРасчета";
	ИначеЕсли НазваниеТипаВМетаданных = "ПланыОбмена" Тогда
		Возврат "ПланОбмена";
	ИначеЕсли НазваниеТипаВМетаданных = "БизнесПроцессы" Тогда
		Возврат "БизнесПроцесс";
	ИначеЕсли НазваниеТипаВМетаданных = "Задачи" Тогда
		Возврат "Задача";
	ИначеЕсли НазваниеТипаВМетаданных = "Документы" Тогда
		Возврат "Документ";
	Иначе
