...
Процедура Подключаемый_КонстантаПриИзменении(Элемент)
	...
	КонстантаПриИзменении(ИмяКонстанты);
КонецПроцедуры

&НаКлиенте
Процедура Подключаемый_КонстантаНажатие(Элемент, СтандартнаяОбработка)
	...
	СтрокаКонстанты = НайденныеСтроки[0];

	ПараметрыОповещения = Новый Структура;
	ПараметрыОповещения.Вставить("ИмяКонстанты", ИмяКонстанты);
	ПараметрыОповещения.Вставить("ИдентификаторСтрокиКонстанты", СтрокаКонстанты.ПолучитьИдентификатор());

	УИ_ОбщегоНазначенияКлиент.РедактироватьТипХранилищеЗначения(СтрокаКонстанты.ЗначениеКонстанты,
																Новый ОписаниеОповещения("КонстантаНажатиеЗавершение",
...
&НаКлиенте
Процедура КонстантаПриИзменении(ИмяКонстанты)
...
Процедура ВывестиЭлементыКонстантНаФорму()
	...
	Для Каждого ТекКонстанта Из ТаблицаКонстант Цикл
		...
		Если ТекКонстанта.ЕстьХранилищеЗначения Тогда
			...
			ОписаниеЭлемента.Действия.Вставить("Нажатие", "Подключаемый_КонстантаНажатие");

		КонецЕсли;
		ОписаниеЭлемента.Параметры.Вставить("ПоложениеЗаголовка", ПоложениеЗаголовкаЭлементаФормы.Нет);
		ОписаниеЭлемента.Параметры.Вставить("РастягиватьПоГоризонтали", Истина);

		ОписаниеЭлемента.Действия.Вставить("ПриИзменении", "Подключаемый_КонстантаПриИзменении");
