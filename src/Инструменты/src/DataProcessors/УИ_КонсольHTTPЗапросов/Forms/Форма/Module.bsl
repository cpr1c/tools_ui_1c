...
&НаКлиенте
Функция СортироватьИнтервалыПоНачалу(МассивИнтервалов)
	
	СортированоМассив = Новый Массив;
	
	Пока МассивИнтервалов.Количество() > 0 Цикл
		МинимальныйИндекс = 0;
		Для Номер = 1 По МассивИнтервалов.ВГраница() Цикл
			Если МассивИнтервалов[Номер].Начало < МассивИнтервалов[МинимальныйИндекс].Начало Тогда
				МинимальныйИндекс = Номер;
			КонецЕсли;
		КонецЦикла;
		
		СортированоМассив.Добавить(МассивИнтервалов[МинимальныйИндекс]);
		МассивИнтервалов.Удалить(МинимальныйИндекс);
	КонецЦикла;
	
	Возврат СортированоМассив;
