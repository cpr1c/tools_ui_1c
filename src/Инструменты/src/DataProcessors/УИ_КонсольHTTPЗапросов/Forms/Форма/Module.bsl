...
&НаКлиенте
Процедура ДеревоЗапросовПередНачаломДобавления(Элемент, Отказ, Копирование, Родитель, ЭтоГруппа, Параметр)
...
Процедура УстановитьДоступностьТелаЗапроса(Форма)
	Форма.Элементы.ГруппаСтраницаЗапросаТело.Видимость = Не ЗапросБезТелаЗапроса(Форма.ЗапросHTTP);
КонецПроцедуры
