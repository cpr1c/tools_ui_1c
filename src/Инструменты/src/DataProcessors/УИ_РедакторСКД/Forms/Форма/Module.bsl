...
&НаКлиенте
Функция ПоляДляФормыРедактированияВыражения()
	Поля = Новый Массив;
...
&НаКлиенте
Процедура ОткрытьФормуРедактированияВыражения(Текст, ОписаниеОповещенияОЗакрытии, Заголовок = "",
	...
	ПараметрыФормы.Вставить("Поля", ПоляДляФормыРедактированияВыражения());
