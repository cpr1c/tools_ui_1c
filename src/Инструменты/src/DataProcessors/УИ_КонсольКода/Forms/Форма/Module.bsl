...
&НаКлиенте
Перем УИ_РедакторКодаНеобработанныеСобытия Экспорт;
...
Процедура УстановитьТекстРедактора(ИдентификаторРедактора, ТекстАлгоритма, УстановитьОригинальныйТекст = Ложь)
	...
	Если УстановитьОригинальныйТекст Тогда
		УИ_РедакторКодаКлиент.УстановитьОригинальныйТекстРедактора(ЭтотОбъект, ИдентификаторРедактора, ТекстАлгоритма);
	КонецЕсли;
