...
Процедура ВыполнитьКод(Команда)
	...
	КлиентскиеРедакторы.Добавить("Клиент");
	
	СтруктураИменПеременныхРедакторов = Новый Структура;
	
	МассивИмен = Новый Массив;
	Для Каждого Стр Из ПеременныеКлиент Цикл
		МассивИмен.Добавить(стр.Имя);
	КонецЦикла;
	МассивИмен.Добавить("СтруктураПередачи");
	СтруктураИменПеременныхРедакторов.Вставить("Клиент", МассивИмен);
	
	МассивИмен = Новый Массив;
	Для Каждого Стр Из ПеременныеСервер Цикл
		МассивИмен.Добавить(стр.Имя);
	КонецЦикла;
	МассивИмен.Добавить("СтруктураПередачи");
	СтруктураИменПеременныхРедакторов.Вставить("Сервер", МассивИмен);
...
Процедура ВыполнитьАлгоритмНаКлиенте(СтруктураПередачи)
	...
	РезультатВыполнения = УИ_РедакторКодаКлиентСервер.ВыполнитьАлгоритм(ТекстАлгоритмаКлиент,
																		КонтекстВыполнения,
																		Истина,
																		ЭтотОбъект,
																		"Клиент");
...
Процедура ВыполнитьАлгоритмНаСервере(СтруктураПередачи)
	...
	РезультатВыполнения = УИ_РедакторКодаКлиентСервер.ВыполнитьАлгоритм(ТекстАлгоритмаСервер,
																		КонтекстВыполнения,
																		Ложь,
																		ЭтотОбъект,
																		"Сервер");
