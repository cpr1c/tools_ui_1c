...
Процедура ИсходныйОбъектНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	УИ_ОбщегоНазначенияКлиент.ПолеФормыНачалоВыбораЗначения(ЭтотОбъект, Элемент, Объект.ИсходныйОбъект,
		СтандартнаяОбработка, Новый ОписаниеОповещения("ИсходныйОбъектНачалоВыбораЗавершениеВыбораПустогоЗначенияТипа",
		ЭтотОбъект), "Ссылки");
КонецПроцедуры
...
&НаКлиенте
Процедура ИсходныйОбъектНачалоВыбораЗавершениеВыбораПустогоЗначенияТипа(Результат, ДополнительныеПараметры) Экспорт
