...
Процедура ДеревоМетаданныхВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	УстановитьВидимостьДереваМетаданных(Ложь);
КонецПроцедуры
...
Процедура ПоказатьДеревоМетаданных(Команда)
	...
	УстановитьВидимостьДереваМетаданных();
...
&НаКлиенте
Процедура УстановитьВидимостьДереваМетаданных(Знач ВидимостьДерева = Неопределено)
