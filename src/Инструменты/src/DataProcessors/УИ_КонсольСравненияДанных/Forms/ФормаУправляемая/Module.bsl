...
&НаКлиенте
Процедура ВыполнитьПроцедуруНаКлиенте(ИмяПроцедуры)
...
&НаКлиенте
Процедура ПосетитьСтраницуОбработкиНаКлиенте()
...
&НаКлиенте
Процедура ДляВызоваИзКоманды_СохранитьНастройкиВФайлНаКлиенте()
	
	СохранитьНастройкиВФайлНаКлиенте(Ложь);
	
КонецПроцедуры

&НаКлиенте
Процедура ДляВызоваИзКоманды_СохранитьНастройкиИТабличныеДокументыВФайлНаКлиенте()
...
&НаКлиенте
Процедура ДляВызоваИзКоманды_СохранитьНастройкиВБазуНаКлиенте()
	
	СохранитьНастройкиВБазуНаКлиенте(Ложь);
	
КонецПроцедуры

&НаКлиенте
Процедура ДляВызоваИзКоманды_СохранитьНастройкиИТабличныеДокументыВБазуНаКлиенте()
...
&НаКлиенте
Процедура ДляВызоваИзКоманды_ОткрытьНастройкиИзФайлаНаКлиенте()
...
&НаКлиенте
Процедура ДляВызоваИзКоманды_ОткрытьНастройкиИТабличныеДокументыИзФайлаНаКлиенте()
...
&НаКлиенте
Процедура ДляВызоваИзКоманды_ОткрытьНастройкиИзБазыНаКлиенте()
...
&НаКлиенте
Процедура ДляВызоваИзКоманды_ОткрытьНастройкиИТабличныеДокументыИзБазыНаКлиенте()
...
&НаСервере
Функция ВыгрузитьРезультатВФайлНаСервере(ДляКлиента, ПредставленияЗаголовковРеквизитов, ФорматФайлаВыгрузки = Неопределено)
	...
	АдресФайла = РеквизитОбъект.ВыгрузитьРезультатВФайлНаСервере(ДляКлиента, ФорматФайлаВыгрузки);
	Возврат АдресФайла;
...
Процедура КомандаВыгрузитьРезультатВФайлНаКлиентеЗавершениеВопрос(РезультатВопроса, ДополнительныеПараметры) Экспорт
	...
	ДиалогСохраненияФайла.Фильтр = "*.CSV|*.CSV|*.TXT|*.TXT|*.XLS|*.XLS|*.XLSX|*.XLSX|*.ODS|*.ODS|*.MXL|*.MXL|*.DOCX|*.DOCX|*.HTML|*.HTML|*.PDF|*.PDF";
	ДиалогСохраненияФайла.Заголовок = "Выберите каталог"; 
	
	ДиалогСохраненияФайла.Показать(Новый ОписаниеОповещения("КомандаВыгрузитьРезультатВФайлНаКлиентеЗавершение", ЭтаФорма, Новый Структура("ДиалогСохраненияФайла", ДиалогСохраненияФайла)));
...
Процедура КомандаВыгрузитьРезультатВФайлНаКлиентеЗавершение(ВыбранныеФайлы, ДополнительныеПараметры) Экспорт
	...
	НомерРазделителяТочка = СтрНайти(ПолноеИмяФайла, ".", НаправлениеПоиска.СКонца);
	РасширениеФорматФайла = ВРег(Сред(ПолноеИмяФайла, НомерРазделителяТочка + 1));
	
	Если (ВыбранныеФайлы <> Неопределено) Тогда
		
		АдресФайла = ВыгрузитьРезультатВФайлНаСервере(Истина, ПредставленияЗаголовковРеквизитов, РасширениеФорматФайла);
...
Процедура СкопироватьТекстЗапросаИзДругогоИсточника(ИдентификаторИсточника, ИдентификаторПриемника)
	
	Объект["ТекстЗапроса" + ИдентификаторПриемника] = Объект["ТекстЗапроса" + ИдентификаторИсточника];
...
Процедура ОбновитьВидимостьДоступностьЭлементовФормыПоИдентификаторуБазы(ИдентификаторБазы)
	...
	ИдентификаторВторойБазы = ?(ИдентификаторБазы = "А", "Б", "А");
	...
	ВыбранноеЗначениеТипаБазы = Элементы["ТипБазы" + ИдентификаторБазы].СписокВыбора.НайтиПоЗначению(Объект["ТипБазы" + ИдентификаторБазы]);
	ПредставлениеИсточникаДанных = СокрЛП(ВыбранноеЗначениеТипаБазы.Представление + ?(Объект["ТипБазы" + ИдентификаторБазы] = 3, " " + Объект["ПодключениеКВнешнейБазе" + ИдентификаторБазы + "ФорматФайла"], ""));
	
	Элементы["ГруппаБаза"  + ИдентификаторБазы + "Страница"].Заголовок = "Источник " + ИдентификаторБазы + " (" + ПредставлениеИсточникаДанных + ")";
...
#Область _1C_8_внешняя
	...
	Если Объект["ТипБазы" + ИдентификаторБазы] = 1 Тогда
		...
		Элементы["КомандаСкопироватьТекстЗапросаИзИсточника" + ИдентификаторБазы].Видимость = 			Объект["ТипБазы" + ИдентификаторВторойБазы] = 0 Или Объект["ТипБазы" + ИдентификаторВторойБазы] = 1;
		...
		Элементы["НастройкиФайла" + ИдентификаторБазы + "ПроизвольныйКод"].Видимость = 					Ложь;
...
#Область SQL
	...
	ИначеЕсли Объект["ТипБазы" + ИдентификаторБазы] = 2 Тогда
		...
		Элементы["ГруппаСтраницаТекстЗапроса" + ИдентификаторБазы].Видимость 							= Истина;
		Элементы["ГруппаСтраницаТекстЗапроса" + ИдентификаторБазы].Заголовок							= "Текст запроса";
		Элементы["КомандаСкопироватьТекстЗапросаИзИсточника" + ИдентификаторБазы].Видимость = 			Объект["ТипБазы" + ИдентификаторВторойБазы] = 2;
		Элементы["ДекорацияТекстЗапроса" + ИдентификаторБазы].Видимость									= Истина;
...
#Область Файл
	...
	ИначеЕсли Объект["ТипБазы" + ИдентификаторБазы] = 3 Тогда
		...
		Элементы["НастройкиФайла" + ИдентификаторБазы + "ПроизвольныйКод"].Видимость = 					Истина;
...
#Область _1C_7_7_внешняя
	...
	ИначеЕсли Объект["ТипБазы" + ИдентификаторБазы] = 5 Тогда
		...
		Элементы["ГруппаСтраницаТекстЗапроса" + ИдентификаторБазы].Видимость 							= Истина;
		Элементы["ГруппаСтраницаТекстЗапроса" + ИдентификаторБазы].Заголовок							= "Текст запроса";
		Элементы["КомандаСкопироватьТекстЗапросаИзИсточника" + ИдентификаторБазы].Видимость = 			Объект["ТипБазы" + ИдентификаторВторойБазы] = 5;
		Элементы["ДекорацияТекстЗапроса" + ИдентификаторБазы].Видимость									= Истина;
		Элементы["ГруппаТекстЗапроса" + ИдентификаторБазы + "Команды"].Видимость 						= Ложь;
...
#Область Строка_JSON
	...
	ИначеЕсли Объект["ТипБазы" + ИдентификаторБазы] = 6 Тогда
		...
		Элементы["КомандаСкопироватьТекстЗапросаИзИсточника" + ИдентификаторБазы].Видимость = 			Объект["ТипБазы" + ИдентификаторВторойБазы] = 6;
...
Процедура ОткрытьНастройкиИзФайлаНаСервере(Адрес, ЗагружатьТабличныеДокументы = Ложь)
	...
	Если Не Данные.Свойство("ТипПериода") Тогда
		Если Данные.Свойство("ТипПериодаАбсолютный") Тогда
			Объект.ТипПериода = ?(Данные.ТипПериодаАбсолютный, 0, 1);
		КонецЕсли;
	КонецЕсли;
...
#Область Команды
&НаКлиенте
Процедура КомандаСравнитьДанные(Команда)
...
&НаКлиенте
Процедура КомандаКонструкторЗапросаБ(Команда)
...
&НаКлиенте
Процедура КомандаКонструкторЗапросаА(Команда)
...
&НаКлиенте
Процедура КомандаСохранитьНастройкиВФайл(Команда)
	
	ДляВызоваИзКоманды_СохранитьНастройкиВФайлНаКлиенте();
...
Процедура СохранитьНастройкиИТабличныеДокументыВФайл(Команда)
	...
	ДляВызоваИзКоманды_СохранитьНастройкиИТабличныеДокументыВФайлНаКлиенте();
	
КонецПроцедуры

&НаКлиенте
Процедура КомандаСохранитьНастройкиВБазу(Команда)
	
	ДляВызоваИзКоманды_СохранитьНастройкиВБазуНаКлиенте();
...
Процедура СохранитьНастройкиИТабличныеДокументыВБазу(Команда)
	...
	ДляВызоваИзКоманды_СохранитьНастройкиИТабличныеДокументыВБазуНаКлиенте();
	
КонецПроцедуры

&НаКлиенте
Процедура КомандаОткрытьНастройкиИзФайла(Команда)
	
	ДляВызоваИзКоманды_ОткрытьНастройкиИзФайлаНаКлиенте();
...
Процедура ЗагрузитьНастройкиИТабличныеДокументыИзФайла(Команда)
	...
	ДляВызоваИзКоманды_ОткрытьНастройкиИТабличныеДокументыИзФайлаНаКлиенте();
	
КонецПроцедуры

&НаКлиенте
Процедура КомандаОткрытьНастройкиИзБазы(Команда)
	
	ДляВызоваИзКоманды_ОткрытьНастройкиИзБазыНаКлиенте();
...
Процедура ЗагрузитьНастройкиИТабличныеДокументыИзБазы(Команда)
	...
	ДляВызоваИзКоманды_ОткрытьНастройкиИТабличныеДокументыИзБазыНаКлиенте();
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Иначе		
		...
		МакетКартинкаДополнительныеКоманды 	= РеквизитФормыВЗначение("Объект").ПолучитьМакет("КартинкаДополнительныеКоманды");
		МакетКартинкаДискета 				= РеквизитФормыВЗначение("Объект").ПолучитьМакет("КартинкаДискета");
		МакетКартинкаПапка 					= РеквизитФормыВЗначение("Объект").ПолучитьМакет("КартинкаПапка");
	...
	КнопкаДополнительныеКоманды = ПоместитьВоВременноеХранилище(МакетКартинкаДополнительныеКоманды, УникальныйИдентификатор);
	КнопкаДискета = ПоместитьВоВременноеХранилище(МакетКартинкаДискета, УникальныйИдентификатор);
	КнопкаПапка = ПоместитьВоВременноеХранилище(МакетКартинкаПапка, УникальныйИдентификатор);
...
Процедура КомандаВыгрузитьРезультатВФайлНаКлиенте(Команда)
	...
	ПоказатьВопрос(Новый ОписаниеОповещения("КомандаВыгрузитьРезультатВФайлНаКлиентеЗавершениеВопрос", ЭтаФорма, Новый Структура("ФорматФайлаВыгрузки", "TXT")), "Выгрузить таблицу в файл на клиенте?", РежимДиалогаВопрос.ДаНет,, КодВозвратаДиалога.Нет, "Выгрузка");
...
&НаКлиенте
Процедура КнопкаДополнительныеКомандыНажатие(Элемент, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	
	//СписокЗначений = Новый СписокЗначений;
	//СписокЗначений.Добавить("ПосетитьСтраницуОбработкиНаКлиенте", "Посетить страницу обработки на Инфостарте",, БиблиотекаКартинок.ДобавитьВИзбранное);
	//
	//ВыбранныйЭлементСписка = ВыбратьИзМеню(СписокЗначений, Элементы.КнопкаДополнительныеКоманды);
	//Если ВыбранныйЭлементСписка <> Неопределено Тогда
	//
	//	ВыполнитьПроцедуруНаКлиенте(ВыбранныйЭлементСписка.Значение + "();");
	//
	//КонецЕсли; 
	
	ПосетитьСтраницуОбработкиНаКлиенте();
	
КонецПроцедуры

&НаКлиенте
Процедура КнопкаДискетаНажатие(Элемент, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	
	СписокЗначений = Новый СписокЗначений;
	СписокЗначений.Добавить("ДляВызоваИзКоманды_СохранитьНастройкиВФайлНаКлиенте", "Сохранить операцию сравнения в файл",, БиблиотекаКартинок.СохранитьФайл);
	СписокЗначений.Добавить("ДляВызоваИзКоманды_СохранитьНастройкиИТабличныеДокументыВФайлНаКлиенте", "Сохранить операцию сравнения и табличные документы в файл",, БиблиотекаКартинок.СохранитьФайл);
	СписокЗначений.Добавить("ДляВызоваИзКоманды_СохранитьНастройкиВБазуНаКлиенте", "Сохранить операцию сравнения в справочник",, БиблиотекаКартинок.СохранитьНастройкиОтчета);
	СписокЗначений.Добавить("ДляВызоваИзКоманды_СохранитьНастройкиИТабличныеДокументыВБазуНаКлиенте", "Сохранить операцию сравнения и табличные документы в справочник",, БиблиотекаКартинок.СохранитьНастройкиОтчета);
		
	ВыбранныйЭлементСписка = ВыбратьИзМеню(СписокЗначений, Элементы.КнопкаДискета);
	Если ВыбранныйЭлементСписка <> Неопределено Тогда
...
&НаКлиенте
Процедура КнопкаПапкаНажатие(Элемент, СтандартнаяОбработка)
	
	СтандартнаяОбработка = Ложь;
	
	СписокЗначений = Новый СписокЗначений;
	СписокЗначений.Добавить("ДляВызоваИзКоманды_ОткрытьНастройкиИзФайлаНаКлиенте", "Загрузить операцию сравнения из файла",, БиблиотекаКартинок.ОткрытьФайл);
	СписокЗначений.Добавить("ДляВызоваИзКоманды_ОткрытьНастройкиИТабличныеДокументыИзФайлаНаКлиенте", "Загрузить операцию сравнения и табличные документы из файла",, БиблиотекаКартинок.ОткрытьФайл);
	СписокЗначений.Добавить("ДляВызоваИзКоманды_ОткрытьНастройкиИзБазыНаКлиенте", "Загрузить операцию сравнения из справочника",, БиблиотекаКартинок.ЗагрузитьНастройкиОтчета);
	СписокЗначений.Добавить("ДляВызоваИзКоманды_ОткрытьНастройкиИТабличныеДокументыИзБазыНаКлиенте", "Загрузить операцию сравнения и табличные документы из справочника",, БиблиотекаКартинок.ЗагрузитьНастройкиОтчета);
		
	ВыбранныйЭлементСписка = ВыбратьИзМеню(СписокЗначений, Элементы.КнопкаПапка);
	Если ВыбранныйЭлементСписка <> Неопределено Тогда
...
&НаКлиенте
Процедура КомандаСкопироватьТекстЗапросаИзИсточникаА(Команда)
	
	СкопироватьТекстЗапросаИзДругогоИсточника("А", "Б");
	
КонецПроцедуры

&НаКлиенте
Процедура КомандаСкопироватьТекстЗапросаИзИсточникаБ(Команда)
	
	СкопироватьТекстЗапросаИзДругогоИсточника("Б", "А");
