...
Перем Совместимость8_3_6;   // - Булево         - флаг совместимости с версией 8.3.6
...
Функция ПолучитьОписаниеВидаОбъектов(Имя, ТекИБ = Неопределено) Экспорт
	...
	Если ТипЗнч(Имя) = Тип("Тип") Тогда
		ОписаниеМетаданных = КэшМетаданных()[Имя];
...
Функция СсылкаВСтруктуру(Значение) Экспорт
	...
	Иначе
		...
		Если ОписаниеМетаданного.Коллекция = "Справочники"
		 ИЛИ ОписаниеМетаданного.Коллекция = "ПланыВидовХарактеристик"
		 ИЛИ ОписаниеМетаданного.Коллекция = "ПланыСчетов"
		 ИЛИ ОписаниеМетаданного.Коллекция = "ПланыВидовРасчета" Тогда
...
Функция Совместимость8_3_6()
	...
	Если НЕ Совместимость8_3_6 = Неопределено Тогда
		Возврат Совместимость8_3_6;
	КонецЕсли;
