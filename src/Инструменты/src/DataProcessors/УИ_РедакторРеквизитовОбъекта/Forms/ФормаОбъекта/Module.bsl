...
Процедура вЗаполнитьСтандартныеРеквизиты(ОбъектМД)
	...
	ПереченьРеквизитов = "Код, Номер, Дата, Проведен, ПометкаУдаления, ЭтоГруппа, Наименование, Владелец, Родитель, БизнесПроцесс, Выполнена, Завершен, Стартован, НомерОтправленного, НомерПринятого, ЭтотУзел, ИмяПредопределенныхДанных, Предопределенный";
