...
&НаКлиенте
Процедура ТабличнаяЧастьРеквизитНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
...
&НаКлиенте
Процедура ТабличнаяЧастьРеквизитОчистка(Элемент, СтандартнаяОбработка)
	ТаблицаФормыЭлемента = Элемент.Родитель;
		...
		Если МассивКСозданию.Количество() <> 0 Тогда
			...
			Для Каждого ЭлемТЧ Из ОбъектМД.ТабличныеЧасти Цикл
				...
				Для Каждого Элем Из ЭлемТЧ.Реквизиты Цикл
					...
					НоваяКолонка.УстановитьДействие("НачалоВыбора", "ТабличнаяЧастьРеквизитНачалоВыбора");
					НоваяКолонка.УстановитьДействие("Очистка", "ТабличнаяЧастьРеквизитОчистка");
				КонецЦикла;
