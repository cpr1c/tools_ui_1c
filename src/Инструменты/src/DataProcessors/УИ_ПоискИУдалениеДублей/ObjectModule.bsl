...
//
// Параметры:
//   ЗаменыТребующиеSQL - ТаблицаЗначений - таблица замен, в которую добавляются строки.
//   МетаДок - ОбъектМетаданных - метаданные документа-регистратора.
//   Дубль - ЛюбаяСсылка - ссылка-дубль.
//   Оригинал - ЛюбаяСсылка - ссылка-оригинал.
