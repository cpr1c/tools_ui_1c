...
Процедура ТипОбъектовДляВыгрузкиНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПараметрыРедактирования.ТипДанных = ТипОбъектовДляВыгрузки;
	ПараметрыРедактирования.РежимЗапуска = РежимыЗапуска.ТипыХраненияДанных;
	ПараметрыРедактирования.НаборТипов = "Ссылки";
	Оповещение = Новый ОписаниеОповещения("ТипОбъектовДляВыгрузкиНачалоВыбораЗавершение", ЭтотОбъект);
	УИ_ОбщегоНазначенияКлиент.РедактироватьТип(ПараметрыРедактирования, Элемент, Оповещение, СтандартнаяОбработка);
