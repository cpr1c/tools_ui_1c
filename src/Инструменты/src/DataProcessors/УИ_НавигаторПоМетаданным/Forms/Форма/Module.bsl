...
Функция вСформироватьСтруктуруУзлаДЗ(ВидУзла = "", Имя = "", ПолноеИмя = "", Синоним = "", ЕстьДети = Ложь,
	ПредставлениеОбъекта = "", СвойстваОбъекта = "", Комментарий = "")
	Струк = Новый Структура("ВидУзла, Имя, ПолноеИмя, Синоним, ПредставлениеОбъекта, СвойстваОбъекта, ЕстьДети, Расширение, ИзмененРасширениями, Комментарий",
		ВидУзла, Имя, ПолноеИмя, Синоним, ПредставлениеОбъекта, СвойстваОбъекта, ЕстьДети, Ложь, Ложь, Комментарий);
	Возврат Струк;
КонецФункции

&НаСервереБезКонтекста
Функция вСформироватьУзелКонфигурация()
	Струк = Новый Структура("Имя, Синоним, Версия, Комментарий", "", "", "", "");
	...
	Возврат вСформироватьСтруктуруУзлаДЗ("Конфигурация",
										 Струк.Имя,
										 "Конфигурация",
										 Струк.Синоним,
										 ,
...
Функция вПолучитьСоставРазделаМД(Знач ИмяРаздела, Знач ОтборПоПодсистемам, Знач пСПодчиненными = ложь)
	...
	Таблица.Колонки.Добавить("Комментарий", ТипСтрока);
