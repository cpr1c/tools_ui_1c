...
#КонецОбласти
#Область ОбработчикиСобытийЭлементовТаблицыФормыТаблицаСохраненныхНастроек
&НаКлиенте
Процедура ТаблицаСохраненныхНастроекВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	СтандартнаяОбработка = Ложь;
	ВыполнитьОтладкуСтрокиСохраненныхНастроек(ВыбраннаяСтрока);
КонецПроцедуры
#КонецОбласти
...
Процедура ВыполнитьОтладку(Команда)
	ВыполнитьОтладкуСтрокиСохраненныхНастроек(Элементы.ТаблицаСохраненныхНастроек.ТекущаяСтрока);
...
&НаКлиенте
Процедура ВыполнитьОтладкуСтрокиСохраненныхНастроек(ИдентификаторСтроки)
	Если ИдентификаторСтроки = Неопределено Тогда
		Возврат;
	КонецЕсли;

	ТекДанные = ТаблицаСохраненныхНастроек.НайтиПоИдентификатору(ИдентификаторСтроки);
