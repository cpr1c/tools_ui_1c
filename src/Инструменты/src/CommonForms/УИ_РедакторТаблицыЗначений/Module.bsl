...
Процедура ЗаполнитьВнешнимиДанными(Команда)
	...
	ОткрытьФорму("ОбщаяФорма.УИ_РедакторТабличногоДокумента", ПараметрыОткрытия, ЭтотОбъект, , , , 
...
&НаСервере
Процедура ПолучитьТаблицуЗначенийИЗаполнитьФорму(Знач МассивСДанными)
