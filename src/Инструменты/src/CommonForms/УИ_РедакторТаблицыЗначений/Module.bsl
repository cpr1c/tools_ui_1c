...
Функция РезультатТаблицаЗначенийВСтроку()
	...
	Если ВозвратХранилищаДляКонтейнераЗначения Тогда
		ХранилищеРезультат = УИ_ОбщегоНазначенияКлиентСервер.НовыйХранилищеЗначенияТаблицыЗначений();
		ХранилищеРезультат.Значение = ЗначениеВСтрокуВнутр(ТаблицаРезультата);
		ХранилищеРезультат.КоличествоСтрок = ТаблицаРезультата.Количество();
		ХранилищеРезультат.КоличествоКолонок = ТаблицаРезультата.Колонки.Количество();
		
		Возврат ХранилищеРезультат;	
	Иначе
