...
Процедура ЗаполнитьВнешнимиДанными(Команда)
	...
	ОписаниеОповещенияОЗакрытииОткрываемойФормы = Новый ОписаниеОповещения("ВводДанныхВТабличноеПолеЗакрытиеФормы", ЭтотОбъект);
	ПараметрыОткрытия = Новый Структура;
	ПараметрыОткрытия.Вставить("ВнешнийИсточникДанных", Истина);
	ПараметрыОткрытия.Вставить("Редактирование", Истина);
	ОткрытьФорму("ОбщаяФорма.УИ_РедакторТабличногоДокумента", ПараметрыОткрытия, ЭтотОбъект,,,,ОписаниеОповещенияОЗакрытииОткрываемойФормы, РежимОткрытияОкнаФормы.БлокироватьОкноВладельца);	
...
&НаСервере
Процедура ПолучитьТаблицуЗначенийИЗаполнитьФорму(МассивСДанными)
	
	Таблица = УИ_ОбщегоНазначения.МассивСтруктурВТаблицуЗначений(МассивСДанными);	
...
&НаКлиенте
Процедура ВводДанныхВТабличноеПолеЗакрытиеФормы(РезультатЗакрытия, ДополнительныеПараметры) Экспорт
	
	Если РезультатЗакрытия = Неопределено Тогда
		Возврат;
	КонецЕсли;
	
	ПолучитьТаблицуЗначенийИЗаполнитьФорму(РезультатЗакрытия.МассивСДанными);	
