...
Процедура Подключаемый_ПолеТаблицыЗначенийНачалоВыбора(Элемент, ДанныеВыбора, СтандартнаяОбработка)
	...
	ПараметрыОбработчика.ИмяПоляВСтруктуре = СтрокаКолонкиТаблицы.Имя;
	...
	ПараметрыОбработчика.ИмяПоляКонтейнера = ИмяВспомогательнойКолонкиТаблицы(СтрокаКолонкиТаблицы.Имя,
																			  УИ_ОбщегоНазначенияКлиентСервер.СуффиксИмениПоляХраненияКонтейнераДляПоляСКонтейнером());
	ПараметрыОбработчика.ИмяПоляТипаЗначения = ИмяВспомогательнойКолонкиТаблицы(СтрокаКолонкиТаблицы.Имя,
																				УИ_ОбщегоНазначенияКлиентСервер.СуффиксИмениПоляХраненияТипаЗначенияДляПоляСКонтейнером());
	ПараметрыОбработчика.ИмяПоляПредставленияТипаЗначения = ИмяВспомогательнойКолонкиТаблицы(СтрокаКолонкиТаблицы.Имя,
