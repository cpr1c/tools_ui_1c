...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ВнешнийИсточникДанных") Тогда
		Если Параметры.ВнешнийИсточникДанных Тогда
			ВнешнийИсточникДанных = Истина;
		КонецЕсли;	
	КонецЕсли;
...
Процедура Применить(Команда)
	Если ВнешнийИсточникДанных Тогда
		МассивСДанными = ПолучитьДанныеТабличногоДокументаВВидеМассива();
	
		ВозвращаемыеДанные = Новый Структура();
		ВозвращаемыеДанные.Вставить("МассивСДанными", МассивСДанными);
...
&НаСервере
Функция ПолучитьДанныеТабличногоДокументаВВидеМассива()
	...
	Попытка
		...
		МассивСДанными = УИ_ОбщегоНазначения.ТаблицаЗначенийВМассив(ТабличныеДанные);
		
		Возврат МассивСДанными;
	Исключение
