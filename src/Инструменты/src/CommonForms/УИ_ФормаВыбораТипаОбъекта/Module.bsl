...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ПоказатьВыборФормыСписка")
		И Параметры.ПоказатьВыборФормыСписка Тогда
		Элементы.ВидФормыСписка.Видимость = Истина;
	КонецЕсли;
...
Процедура ВыбратьОбъект(Команда)
	...
	Если ТекДанные <> Неопределено И Не ПустаяСтрока(ТекДанные.ПолноеИмя) Тогда
		...
		Если Значение <> Неопределено Тогда
			Если Элементы.ВидФормыСписка.Видимость Тогда
				Ответ = Новый Структура;
				Ответ.Вставить("Значение", Значение);
				Ответ.Вставить("ВидФормыСписка", ВидФормыСписка);
