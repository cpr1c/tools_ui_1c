...
Процедура СоздатьЭлементыРедактораКода(Форма, ИдентификаторРедактора, ПолеРедактора, ЯзыкРедактора = "bsl",
...
//5 - конструкток строк на разных языках
...
Функция ТекущиеПараметрыРедактораКода() Экспорт
	...
	Если СохраненныеПараметрыРедактора = Неопределено Тогда
		ПараметрыПоУмолчанию.Вариант = ТекущийВариантРедактораКода1С();
