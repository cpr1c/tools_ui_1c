...
Функция ВариантПоставкиПортативный() Экспорт
	Варианты=ВариантыПоставки();
	Возврат Варианты.Портативный;
КонецФункции

Функция ВариантыПоставки() Экспорт
	Варианты=Новый Структура;
	Варианты.Вставить("Портативный", "Портативный");
	Варианты.Вставить("Расширение","Расширение");
	Варианты.Вставить("РасширениеБезБСП","РасширениеБезБСП");
//	Варианты.Вставить("РасширениеБезБСП","РасширениеБезБСП");
	Варианты.Вставить("Конфигурация","Конфигурация");
