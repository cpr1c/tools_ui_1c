...
Функция ЗначениеПоляСКонтейнеромЗначения(СтруктураДанныхФормы, ПараметрыХраненияПоляСКонейнером) Экспорт
	ДанныеПоля = СтруктураЗначенияПоДаннымФормыПоляСКонейнером(СтруктураДанныхФормы, ПараметрыХраненияПоляСКонейнером);

	Возврат ЗначениеПоляСКонейнеромЗначенияПоСтруктуреДанных(ДанныеПоля);
КонецФункции
...
Процедура УстановитьЗначениеПоляСКонтейнером(СтруктураДанныхФормы, ПараметрыХраненияПоляСКонейнером, НовоеЗначение) Экспорт
	...
	УстановитьЗначениеПоляСКонтейнеромПоСтруктуреДанныхДляПоляСКонтейнером(СтруктураДанныхФормы,
																		   ПараметрыХраненияПоляСКонейнером,
																		   ДанныеДляКонтейнера);
КонецПроцедуры
...
Процедура УстановитьЗначениеПоляСКонтейнеромПоСтруктуреДанныхДляПоляСКонтейнером(СтруктураДанныхФормы,
	ПараметрыХраненияПоляСКонейнером, Данные) Экспорт
	СтруктураДанныхФормы[ПараметрыХраненияПоляСКонейнером.ИмяПоляПредставленияТипаЗначения] = Данные.ПредставлениеТипа;
	СтруктураДанныхФормы[ПараметрыХраненияПоляСКонейнером.ИмяПоляТипаЗначения] = Данные.Тип;
	СтруктураДанныхФормы[ПараметрыХраненияПоляСКонейнером.ИмяПоляВСтруктуре] = Данные.Значение;
	СтруктураДанныхФормы[ПараметрыХраненияПоляСКонейнером.ИмяПоляКонтейнера] = Данные.Контейнер;
КонецПроцедуры
...
Функция ЗначениеВСтруктуруДанныхДляПоляСКонтейнером(Значение) Экспорт
	...
	Иначе
		Данные.Тип = ОписаниеТипаСтрока(100);
...
// Возвращаемое значение:
//  Произвольный
Функция ЗначениеПоляСКонейнеромЗначенияПоСтруктуреДанных(СтруктураЗначения) Экспорт
...
// Возвращаемое значение:
//  см. НовыйСтруктураДанныхДляПоляСКонтейнеромФормы
Функция СтруктураЗначенияПоДаннымФормыПоляСКонейнером(СтруктураДанныхФормы, ПараметрыХраненияПоляСКонейнером) Экспорт
	Данные = НовыйСтруктураДанныхДляПоляСКонтейнеромФормы();
	Данные.Значение = СтруктураДанныхФормы[ПараметрыХраненияПоляСКонейнером.ИмяПоляВСтруктуре];
	Данные.Контейнер = СтруктураДанныхФормы[ПараметрыХраненияПоляСКонейнером.ИмяПоляКонтейнера];
	Данные.Тип = СтруктураДанныхФормы[ПараметрыХраненияПоляСКонейнером.ИмяПоляТипаЗначения];
	Данные.ПредставлениеТипа = СтруктураДанныхФормы[ПараметрыХраненияПоляСКонейнером.ИмяПоляПредставленияТипаЗначения];
...
#КонецЕсли
	...
	ОписаниеТипов = ОписаниеТиповПоТипуДляПоляСКонтейнером(Тип);//ОписаниеТипов
	
	Значение = ЗначениеПоляСКонейнеромЗначенияПоСтруктуреДанных(ДанныеПоля);
