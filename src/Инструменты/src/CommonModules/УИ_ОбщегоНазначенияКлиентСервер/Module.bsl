...
// * ИмяПоляКонтейнера - Неопределено, Строка - 
// * ИмяПоляТипаЗначения - Неопределено, Строка - 
// * ИмяПоляПредставленияТипаЗначения - Неопределено,Строка - 
Функция НовыйСтруктураХраненияРеквизитаНаФормеСКонейнером() Экспорт
	СтруктураХраненияРеквизита = Новый Структура;
	СтруктураХраненияРеквизита.Вставить("ИмяПоляВСтруктуре", "");
	СтруктураХраненияРеквизита.Вставить("ИмяПоляКонтейнера", Неопределено);
	СтруктураХраненияРеквизита.Вставить("ИмяПоляТипаЗначения", Неопределено);
	СтруктураХраненияРеквизита.Вставить("ИмяПоляПредставленияТипаЗначения", Неопределено);
