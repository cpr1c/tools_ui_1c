...
#Область ПреобразованиеЗначенийВИхХранилища
...
Функция ХранитьТипВКонтейнере(ТипЗначения) Экспорт
	ТипыДляКонтейнеров = ТипыЗначенийХранимыеВКонтейнерах();
	Возврат ТипыДляКонтейнеров.Найти(ТипЗначения) <> Неопределено;
КонецФункции
...
#Если НаКлиенте Тогда
	...
	Типы.Добавить(ТипДеревоЗначений());
#Иначе
	Типы.Добавить(Тип("ТаблицаЗначений"));
	Типы.Добавить(Тип("ДеревоЗначений"));
#КонецЕсли
	Типы.Добавить(Тип("Тип"));	
	Типы.Добавить(Тип("ОписаниеТипов"));
