...
//
// Параметры:
//  КомандаСистемы -Строка- Команда системы
//  ЭтоWindows -Булево- Это windows
//
// Возвращаемое значение:
//  Строка - Текст файла запуска команды системы
Функция ТекстФайлаЗапускаКомандыСистемы(КомандаСистемы, ЭтоWindows) Экспорт
	ТекстБлокаПолученияПеременныхОкружения = ТекстБлокаСкриптаПолучениеСпискаПеременныхОкружения(ЭтоWindows);
