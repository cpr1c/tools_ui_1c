...
Процедура ФормаПриОткрытии(Форма, ОписаниеОповещенияОЗавершении = Неопределено) Экспорт
	Форма.УИ_РедакторКодаНеобработанныеСобытия = Новый Массив;
...
Процедура ОтложеннаяОбработкаСобытийРедактора(Форма) Экспорт
	Для Каждого ТекущееСобытие Из Форма.УИ_РедакторКодаНеобработанныеСобытия Цикл
	...
	Форма.УИ_РедакторКодаНеобработанныеСобытия.Очистить();
КонецПроцедуры
...
//	СтандартнаяОбработка = Ложь;
	...
	ИначеЕсли Событие.event = "EVENT_FORMAT_CONSTRUCT" Тогда 
		Если Событие.params <> Неопределено Тогда
			ДанныеСобытияДляОбработки = Новый Структура;
	...
	Форма.УИ_РедакторКодаНеобработанныеСобытия.Добавить(СобытиеДляОбработки);
