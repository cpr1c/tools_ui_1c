...
Функция _Алг(НаименованиеАлгоритма, ТекстАлгоритма = "", Знач Параметр1 = Неопределено, 
	...
	Возврат УИ_АлгоритмыВызовСервера.СозданиеАлгоритма(НаименованиеАлгоритма, ТекстАлгоритма, Параметр1, Параметр2, Параметр3, Параметр4, 
		Параметр5, Параметр6, Параметр7, Параметр8, Параметр9, СтрРазделить(МассивИменПараметров, ","));	
...
Функция _Алг2(ТекстАлгоритма) Экспорт
	...
	Возврат СтрШаблон("УИ_._Алг(""%1"",""%2"",%3, ""%3"")", Лев(ТекстАлгоритма, ПерваяСкобка - 1), ТекстАлгоритма, СтрСоединить(МассивПараметров, ","));
КонецФункции
