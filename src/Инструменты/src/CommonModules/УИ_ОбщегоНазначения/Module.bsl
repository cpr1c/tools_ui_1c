		...
		Для Каждого ОбщийРеквизит Из Метаданные.ОбщиеРеквизиты Цикл
			...
			Для каждого СоставРеквизита из ОбщийРеквизит.Состав Цикл
				Если АвтоИспользование Тогда
					РеквизитИспользуется = (СоставРеквизита.Использование <> СвойстваОбъектов.ИспользованиеОбщегоРеквизита.НеИспользовать);
				Иначе
					РеквизитИспользуется = (СоставРеквизита.Использование = СвойстваОбъектов.ИспользованиеОбщегоРеквизита.Использовать);
				КонецЕсли;
