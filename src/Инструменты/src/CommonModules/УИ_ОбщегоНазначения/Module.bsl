...
Функция РезультатВыполненияКомандыСистемы(ПараметрыВыполнения) Экспорт
	...
	РезультатРазбораВывода = УИ_ОбщегоНазначенияКлиентСервер.РезультатРазбораВыводаКомандыСистемы(ТекстВыводаКоманды);
	РезультатВыполненияКоманды.ВыводКоманды = РезультатРазбораВывода.ВыводКоманды;
	Если РезультатРазбораВывода.УдалосьРаспарситьВыводКоманды Тогда
		РезультатВыполненияКоманды.ТекущийКаталог = РезультатРазбораВывода.ТекущийКаталог;
		РезультатВыполненияКоманды.КодВозврата = РезультатРазбораВывода.КодВозврата;
	КонецЕсли;
