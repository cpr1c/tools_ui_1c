...
Функция КаталогВспомогательныхБиблиотекИнструментовНаСервере() Экспорт
	Возврат УИ_ОбщегоНазначенияКлиентСервер.КаталогВспомогательныхБиблиотекИнструментов(КаталогВременныхФайлов());
КонецФункции
...
Функция КаталогФайловДанныхОтладкиНаСервере() Экспорт
	Возврат УИ_ОбщегоНазначенияКлиентСервер.ОбъединитьПути(КаталогВспомогательныхБиблиотекИнструментовНаСервере(),
														   "ДанныеОтладки");
КонецФункции
