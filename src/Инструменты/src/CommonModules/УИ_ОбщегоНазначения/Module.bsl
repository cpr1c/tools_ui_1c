...
Функция РезультатВыполненияКомандыСистемы(ПараметрыВыполнения) Экспорт
	...
	ТекстФайлаЗапуска = УИ_ОбщегоНазначенияКлиентСервер.ТекстФайлаЗапускаКомандыСистемы(ПараметрыВыполнения.Команда,
	...
	ДвоичныеДанныеСтроки = ПолучитьДвоичныеДанныеИзСтроки(ТекстФайлаЗапуска, КодировкаТекста.UTF8, Ложь);
	...
	ТекстовыйДокументЛогаВыполнения.Прочитать(ИмяфайлаВыводаКоманды);
