...
Функция ЗначениеВКонтейнерДляФормы(Значение) Экспорт
	...
	Если НовыйКонтейнер.Тип = ТипыКонтейнеров.Граница Тогда
		...
		НовыйКонтейнер.Представление = Строка(Хранилище.Значение) + " " + Хранилище.ВидГраницы;;
...
Функция ЗначениеПоляСКонтейнером(СтруктураХраненияЗначения, СтруктураХраненияРеквизитаНаФормеСКонейнером) Экспорт
