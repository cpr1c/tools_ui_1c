...
Функция НовыйОписаниеРеквизитаЭлемента() Экспорт
	...
	ДлинаСтрокиПоУмолчанию = 10;
	СтруктураРеквизита.Вставить("Тип", УИ_ОбщегоНазначенияКлиентСервер.ОписаниеТипаСтрока(ДлинаСтрокиПоУмолчанию));
...
Функция ОписаниеРеквизитаФормы() Экспорт
	...
	ДлинаСтрокиПоУмолчанию = 10;
	Описание.Вставить("Тип", УИ_ОбщегоНазначенияКлиентСервер.ОписаниеТипаСтрока(ДлинаСтрокиПоУмолчанию));
...
Процедура ФормаПриСозданииНаСервереСоздатьРеквизитыПараметровЗаписи(Форма, ГруппаФормы) Экспорт
	...
	ДлинаСтроки255 = 255;
	ОписаниеТипаСтрока255 = УИ_ОбщегоНазначенияКлиентСервер.ОписаниеТипаСтрока(ДлинаСтроки255);
