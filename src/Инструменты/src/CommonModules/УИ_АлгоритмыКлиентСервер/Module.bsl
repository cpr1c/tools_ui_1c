...
// Новый описание шапки алгоритма.
// 
// Возвращаемое значение:
//  Структура -  Новый описание шапки алгоритма:
...
// * ВХранилищеНастроек - Булево - Если установлено Истина, сохранение происходит в хранилище общих настроек в базе
Функция НовыйОписаниеШапкиАлгоритма() Экспорт
	Описание = Новый Структура;
	Описание.Вставить("Идентификатор","");
	Описание.Вставить("Наименование", "");
	Описание.Вставить("Код", "");
	Описание.Вставить("Комментарий","");
	Описание.Вставить("Кэшировать", Ложь);
	Описание.Вставить("НаКлиенте", Ложь);
	Описание.Вставить("ВыбрасыватьИсключение", Ложь);
	Описание.Вставить("ВыполнятьВТранзакции", Ложь);
	Описание.Вставить("ЗаписыватьОшибкиВЖР", Ложь);
	Описание.Вставить("ИдентификаторHTTP", "");
	Описание.Вставить("ИдентификаторРегламентногоЗадания", "");
	Описание.Вставить("ВыполнятьПоРасписанию", Ложь);
	Описание.Вставить("ВХранилищеНастроек", Ложь);
	
	Возврат Описание;
КонецФункции

// Новый описание алгоритма.
// 
// Возвращаемое значение:
//  Структура -  Новый описание шапки алгоритма:
// * Идентификатор - Строка - 
...
Функция НовыйОписаниеАлгоритма() Экспорт
	Описание = НовыйОписаниеШапкиАлгоритма();
	Описание.Вставить("ТекстАлгоритма","");
	Описание.Вставить("Хранилище",Неопределено);
	Описание.Вставить("Параметры", Новый Массив);
	
	Возврат Описание;
КонецФункции

// Новый описание параметра алгоритма.
// 
// Возвращаемое значение:
//  Структура -  Новый описание параметра алгоритма:
// * Вход - Булево - 
// * Имя - Строка - 
// * ТипПараметра - Строка - 
// * ПоУмолчанию - Строка - 
Функция НовыйОписаниеПараметраАлгоритма() Экспорт
	Описание = Новый Структура;
	Описание.Вставить("Вход", Ложь);
	Описание.Вставить("Имя", "");
	Описание.Вставить("ТипПараметра", "");
	Описание.Вставить("ПоУмолчанию", "");
...
// Имя файла текста алгоритма DBF.
// 
// Возвращаемое значение:
//  Строка -  Имя файла текста алгоритма DBF
Функция ИмяФайлаТекстаАлгоритмаDBF() Экспорт
	Возврат "ТекстАлгоритма.txt";
КонецФункции
