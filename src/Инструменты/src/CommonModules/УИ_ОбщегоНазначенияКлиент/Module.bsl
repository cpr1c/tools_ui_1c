...
Процедура ПриЗавершенииРаботыСистемы() Экспорт
	...
	Попытка
		УдалитьФайлы(КаталогВспомогательныхБиблиотекИнструментов);
	Исключение
...
Процедура ОткрытьНовуюФормуИнструмента(ФормаНачальная)
	ИмяФормы = ФормаНачальная.ИмяФормы;
	
	ОткрытьФорму(ИмяФормы, , , Новый УникальныйИдентификатор, , , , РежимОткрытияОкнаФормы.Независимый);
КонецПроцедуры
