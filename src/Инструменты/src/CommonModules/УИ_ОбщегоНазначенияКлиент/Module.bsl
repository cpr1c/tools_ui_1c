...
Процедура ПриНачалеРаботыСистемы() Экспорт
	...
	УИ_ПараметрыПриложения.Вставить("ОписаниеМетаданных", УИ_ОбщегоНазначенияВызовСервера.ОписаниеМетаданныхКонфигурации());
	...
	//ПараметрыСеансаВХранилище.Вставить("ОписаниеМетаданных", УИ_ПараметрыПриложения["ОписаниеМетаданных"]);
