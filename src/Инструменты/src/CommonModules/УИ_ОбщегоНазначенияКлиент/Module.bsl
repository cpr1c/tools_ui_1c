...
Процедура НачатьРедактированиеВременногоХранилищаПоАдресу(АдресВоВременномХранилище,
	...
	ОткрытьФорму("ОбщаяФорма.УИ_РедакторВременногоХранилища",
				 ПараметрыФормы,
				 Владелец,
				 Строка(Новый УникальныйИдентификатор),
				 ,
...
Процедура НачатьРедактированиеЗначенияБезКонтейнераНаФормеВСпециализированнойФорме(Значение,
	...
	Если ТипЗначения = Тип("Строка") Тогда
		...
		Если ЭтоАдресВременногоХранилища(Значение) Тогда
			НачатьРедактированиеВременногоХранилищаПоАдресу(Значение, ОписаниеОповещенияОЗавершении, ВладелецФормы);
		Иначе
