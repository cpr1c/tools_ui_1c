...
//
Процедура ОткрытьНавигаторПоМетаданным(СсылкаНаОбъект) Экспорт
	...
	ПараметрыОткрытия.Параметры.ПолноеИмя = УИ_ОбщегоНазначенияВызовСервера.ПолноеИмяОбъектаМетаданныхПоЗначению(СсылкаНаОбъект);
	ФормаНавигатора = УИ_НавигаторПоМетаданнымКлиент.ФормаНавигатораПоМетаданным(Истина);
...
Процедура ОбработчикКомандыНавигаторПоМетаданным(СсылкаНаОбъект, Контекст) Экспорт
	ОткрытьНавигаторПоМетаданным(СсылкаНаОбъект);
КонецПроцедуры
