...
Процедура НачатьРедактированиеКонтейнераЗначенияВСпециализированнойФорме(КонтейнерЗначения,
	...
	ИначеЕсли УИ_ОбщегоНазначенияКлиентСервер.ЭтотТипКонтейнераПоляФормыРедактируетсяЧерезСтруктуру(КонтейнерЗначения.Тип,
																									ТипыКонтейнеров) Тогда
		РедактироватьТипСтруктура(КонтейнерЗначения.Хранилище, ОписаниеОповещенияОЗавершении, ВладелецФормы);
	ИначеЕсли УИ_ОбщегоНазначенияКлиентСервер.ЭтотТипКонтейнераПоляФормыРедактируетсяЧерезСоответствие(КонтейнерЗначения.Тип,
																									   ТипыКонтейнеров) Тогда
	...
	ИначеЕсли КонтейнерЗначения.Тип = ТипыКонтейнеров.СписокЗначений Тогда
		РедактироватьСписокЗначенийКакХранилищеКонтейнера(КонтейнерЗначения.Хранилище,
														  ОписаниеОповещенияОЗавершении,
														  ВладелецФормы);
	ИначеЕсли УИ_ОбщегоНазначенияКлиентСервер.ЭтотТипКонтейнераПоляФормыРедактируетсяЧерезМассив(КонтейнерЗначения.Тип,
																								 ТипыКонтейнеров) Тогда
