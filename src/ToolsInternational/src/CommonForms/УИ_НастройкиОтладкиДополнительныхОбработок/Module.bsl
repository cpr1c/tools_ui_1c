...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Вид = UT_Common.ЗначениеРеквизитаОбъекта(ДополнительнаяОбработка, "Вид");
	...
	СохраненныеНастройки=UT_Common.НастройкиОтладкиДополнительнойОбработки(ДополнительнаяОбработка);
	ЗаполнитьЗначенияСвойств(ЭтотОбъект, СохраненныеНастройки);
КонецПроцедуры

&НаСервере
Процедура ПрименитьНаСервере()
	СтруктураНастройки=UT_Common.НовыйСтруктураНастройкиОтладкиДополнительнойОбработки();
	ЗаполнитьЗначенияСвойств(СтруктураНастройки, ЭтотОбъект);
	
	UT_Common.ЗаписатьНастройкиОтладкиДополнительнойОбработки(ЭтотОбъект.ДополнительнаяОбработка, СтруктураНастройки);	
КонецПроцедуры
