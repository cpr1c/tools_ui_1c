...
#Иначе
		...
		ОткрытьФорму("Обработка.UT_DCSEditor.Форма", ПараметрыРедактора, ЭтаФорма, , , ,
...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ДанныеОтладки") Тогда
		...
		Возврат;
	КонецЕсли;
	UT_Common.ФормаИнструментаПриСозданииНаСервере(ЭтотОбъект, Отказ, СтандартнаяОбработка, Элементы.ГлавнаяКоманднаяПанель);
