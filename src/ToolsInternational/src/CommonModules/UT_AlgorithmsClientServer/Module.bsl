...
Функция ExecuteAlgorithm(Алгоритм, ВходящиеПараметры = Неопределено, ОшибкаВыполнения = Ложь, СообщениеОбОшибке = "") Экспорт
	АлгоритмСсылка = UT_CommonServerCall.ПолучитьСсылкуСправочникАлгоритмы(Алгоритм);
	...
	СвойстваАлгоритма = UT_CommonServerCall.ЗначенияРеквизитовОбъекта(АлгоритмСсылка,
