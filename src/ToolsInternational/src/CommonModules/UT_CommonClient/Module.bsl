...
Процедура OnStart() Экспорт
	...
	UT_ApplicationParameters.Вставить("ЭтоLinuxКлиент", УИ_ОбщегоНазначенияКлиентСервер.ЭтоLinux());
	UT_ApplicationParameters.Вставить("ЭтоWindowsКлиент", УИ_ОбщегоНазначенияКлиентСервер.ЭтоWindows());
	UT_ApplicationParameters.Вставить("ЭтоВебКлиент", ЭтоВебКлиент());
	UT_ApplicationParameters.Вставить("ЭтоПортативнаяПоставка", УИ_ОбщегоНазначенияКлиентСервер.ЭтоПортативнаяПоставка());
