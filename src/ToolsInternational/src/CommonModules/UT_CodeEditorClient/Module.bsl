...
Процедура СохранитьМодулиКонфигурацииВФайлыЗавершениеПодключенияРасширенияРаботыСФайлами(Результат,
	...
	ПараметрыФормы.Вставить("CurrentDirectories", ДополнительныеПараметры.ТекущиеКаталоги);
	...
	ОткрытьФорму("ОбщаяФорма.UT_ConfigurationSourseFilesSaveSettings", ПараметрыФормы, , , , ,
