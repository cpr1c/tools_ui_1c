Функция ПараметрыСтартаСеанса() Экспорт
	...
	Если Не UT_CommonClientServer.ЭтоПортативнаяПоставка() Тогда
...
Функция КодОсновногоЯзыка() Экспорт
	Возврат UT_CommonServerCall.КодОсновногоЯзыка();
КонецФункции
...
Функция СсылкиПоИменамПредопределенных(ПолноеИмяОбъектаМетаданных) Экспорт
	...
	Возврат UT_CommonCached.СсылкиПоИменамПредопределенных(ПолноеИмяОбъектаМетаданных);
...
Процедура ДобавитьМассивОбъектовКСравнению(Объекты) Экспорт
	UT_Common.ДобавитьМассивОбъектовКСравнению(Объекты);
КонецПроцедуры
