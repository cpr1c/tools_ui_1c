...
Функция РегламентныеЗаданияЗависимыеОтФункциональныхОпций() Экспорт
	...
	//МодульИнтеграцииПодсистемБСП=UT_Common.Commonmodule("ИнтеграцияПодсистемБСП");
	...
	//КонецЕсли;
	//МодульРегламентныеЗаданияПереопределяемый=UT_Common.Commonmodule("РегламентныеЗаданияПереопределяемый");
