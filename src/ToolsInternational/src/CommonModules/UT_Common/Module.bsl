...
Процедура ДобавитьВКоманднуюПанельОбщиеКоманды(Форма, ОсновнаяКоманднаяПанельФормы)
	...
	UT_Forms.СоздатьКомандуПоОписанию(Форма, ОписаниеКоманды);
	UT_Forms.СоздатьКнопкуПоОписанию(Форма, ОписаниеКоманды);
КонецПроцедуры

Procedure ToolFormOnCreateAtServer(Form, Cancel, StandardProcessing, FormMainCommandBar = Undefined) Export
	ДобавитьВКоманднуюПанельОбщиеКоманды(Form, FormMainCommandBar);
EndProcedure
