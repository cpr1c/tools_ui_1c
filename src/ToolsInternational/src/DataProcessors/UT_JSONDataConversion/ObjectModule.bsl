...
//                Ложь   - в противном случае
//
Функция RefExists(Значение) Экспорт
...
Функция НайтиЗначениеПоОписанию(ОписаниеВида, МетаОбъект, ОписаниеЗначения) Экспорт
	...
	Иначе
		Если ОписаниеЗначения.Свойство("ИдПолный") Тогда
			...
			Если RefExists(ВремСсылка) Тогда
				Возврат ВремСсылка;
			КонецЕсли;
...
// 
// Параметры:
// 	Form             - УправляемаяФорма        - Form для обработки
...
//
// Параметры:
//  Form               - УправляемаяФорма         - Form для заполнения данных
