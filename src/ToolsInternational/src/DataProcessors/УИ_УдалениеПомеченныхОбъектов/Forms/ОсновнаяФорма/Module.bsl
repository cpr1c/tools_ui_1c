...
//	УИ_РаботаСФормами.ФормаПриСозданииНаСервереСоздатьРеквизитыПараметровЗаписи(ЭтотОбъект, Элементы.ГруппаПараметрыЗаписи);
	UT_Common.ФормаИнструментаПриСозданииНаСервере(ЭтотОбъект, Отказ, СтандартнаяОбработка, Элементы.КомандыФормы);
...
Процедура ВыполнитьУдаление()
	...
	Если Не Результат.ЗаданиеВыполнено Тогда
		...
		UT_TimeConsumingOperationsClient.ИнициализироватьПараметрыОбработчикаОжидания(ПараметрыОбработчикаОжидания);
		...
		Если Элементы.СтраницыФормы.ТекущаяСтраница = Элементы.ДлительнаяОперация Тогда
			Если ЗаданиеВыполнено(ИдентификаторЗадания) Тогда
				...
				ОбновитьСодержание(Результат.РезультатУдаления, Результат.РезультатУдаления.Значение,
					Результат.РезультатУдаления.ТипыУдаленныхОбъектов);
			Иначе
				UT_TimeConsumingOperationsClient.ОбновитьПараметрыОбработчикаОжидания(ПараметрыОбработчикаОжидания);
...
Функция ЗаданиеВыполнено(ИдентификаторЗадания)
	...
	Возврат UT_TimeConsumingOperations.ЗаданиеВыполнено(ИдентификаторЗадания);
