...
//			УстановитьМонопольныйРежим(False);
		...
		For Each СтрокаТаблицы In ПрепятствуюшиеУдалению Do
			...
			If ИменаРеквизитовИлиЗапрос = Undefined Then
				...
				If ЭтоРегистрСведений Или МетаданныеРегистрыБухгалтерии.Содержит(СтрокаТаблицы.ОбнаруженныйМетаданные) // ЭтоРегистрБухгалтерии

					Или МетаданныеРегистрыНакопления.Содержит(СтрокаТаблицы.ОбнаруженныйМетаданные) Then // ЭтоРегистрНакопления
