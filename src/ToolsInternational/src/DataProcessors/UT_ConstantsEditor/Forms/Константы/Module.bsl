...
Процедура ВывестиЭлементыКонстантНаФорму()
	...
	Для Каждого ТекКонстанта Из ТаблицаКонстант Цикл
		...
		ОписаниеГруппы = UT_Forms.НовыйОписаниеГруппыФормы();
		...
		ГруппаТекущейКонстанты = UT_Forms.СоздатьГруппуПоОписанию(ЭтотОбъект, ОписаниеГруппы);
...
Процедура ЗаписатьНаСервере()
	...
	Для Каждого СтрокаКонстанты Из ТаблицаКонстант Цикл
		...
		Если UT_Common.ЗаписатьОбъектВБазу(МенеджерКонстанты,
...
Процедура КонстантаНажатие(Элемент, СтандартнаяОбработка)
	...
	UT_CommonClient.РедактироватьХранилищеЗначения(ЭтотОбъект, НайденныеСтроки[0].ЗначениеКонстанты);
КонецПроцедуры
