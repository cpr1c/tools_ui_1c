...
Процедура FilterByMessageNumberOptionOnChange(Элемент)
	УстановитьОтборПоНомеруСообщения(СписокКонстант, FilterByMessageNumberOption);
	УстановитьОтборПоНомеруСообщения(СписокСсылок, FilterByMessageNumberOption);
	УстановитьОтборПоНомеруСообщения(СписокНаборовЗаписей, FilterByMessageNumberOption);
	ОбновитьСодержимоеСтраницы();
КонецПроцедуры
