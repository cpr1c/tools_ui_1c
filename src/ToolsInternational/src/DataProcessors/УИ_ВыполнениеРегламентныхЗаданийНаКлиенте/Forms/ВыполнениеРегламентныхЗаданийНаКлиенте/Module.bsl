...
Процедура ИзменитьИспользованиеРегламентногоЗадания(Идентификатор, Выполнять)
	...
	Если Свойства = Неопределено Тогда
		...
		Свойства.ScheduledJobUUID = Идентификатор;
...
//	
	...
	СвойстваФоновогоЗадания.ScheduledJobUUID = Строка(Задание.УникальныйИдентификатор);
...
Функция СвойстваПоследнегоФоновогоЗаданияВыполненияРегламентногоЗадания(РегламентноеЗадание)
	...
	Отбор.Вставить("ScheduledJobUUID", ИдентификаторРегламентногоЗадания);
...
Функция СвойствФоновыхЗаданий(Отбор = Неопределено)
	...
	Если Отбор <> Неопределено И Отбор.Свойство("ScheduledJobUUID") Тогда
		РегламентныеЗаданияДляОбработки = Новый Массив;
		Если Отбор.ScheduledJobUUID <> "" Тогда
			Если РегламентноеЗадание = Неопределено Тогда
				РегламентноеЗадание = РегламентныеЗадания.НайтиПоУникальномуИдентификатору(
					Новый УникальныйИдентификатор(Отбор.ScheduledJobUUID));
			КонецЕсли;
			Если РегламентноеЗадание <> Неопределено Тогда
	...
	Для Каждого РегламентноеЗадание Из РегламентныеЗаданияДляОбработки Цикл
		...
		Если ТипЗнч(Свойства) = Тип("Структура") И Свойства.ScheduledJobUUID = ИдентификаторРегламентногоЗадания
...
Функция ПустаяТаблицаСвойствФоновыхЗаданий()
	...
	НоваяТаблица.Колонки.Добавить("ScheduledJobUUID", Новый ОписаниеТипов("Строка"));
