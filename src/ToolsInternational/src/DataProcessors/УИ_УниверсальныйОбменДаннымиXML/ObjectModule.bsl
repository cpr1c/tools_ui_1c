...
//	КонецЕсли;
	...
	Если Правило.Отбор <> Неопределено Тогда
		...
		UT_CommonClientServer.УстановитьЗначениеПараметраСКД(КомпоновщикНастроек, "ДатаНачала", ДатаНачала);
		UT_CommonClientServer.УстановитьЗначениеПараметраСКД(КомпоновщикНастроек, "ДатаОкончания",
			ДатаОкончания);
...
Функция КодОсновногоЯзыка()
	Возврат UT_CommonClientServer.КодОсновногоЯзыка();
