...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если ТипЗнч(ТипЗначения) = Тип("Структура") И ТипЗначения.Тип = "Тип" Тогда
		...
		Попытка
			маТипы = Новый Массив;
			маТипы.Добавить(РеквизитФормыВЗначение("Объект").Container_RestoreValue(ТипЗначения));
	...
	Иначе
		...
		Если ТипКонтейнера = 3 Тогда
			...
			Таблица = РеквизитФормыВЗначение("Объект").StringToValue(ТипЗначения.Значение);
...
Функция ПолучитьКонтейнерТипа(ОписаниеТипов)
	...
	Возврат Обработка.Container_SaveValue(ВозвращаемыйТип);
...
Функция ПолучитьТаблицу(ТекстЗапроса = Неопределено)
	...
	Возврат Обработка.Container_SaveValue(Таблица);
...
Функция ПолучитьДеревоТипов(ТипЗначенияТекущий, СписокРазрешенных)
	...
	//ДобавитьТип(Типы, ТипЗначенияТекущий, "Неопределено", Pictures);
