...
Процедура ВыполнитьПриложение()
    ...
    Приложение.Опция("exportEDT", Истина, "Опред необходи эксп исход из проекта ЕДТ в формат конфигуратора").ТБулево();
...
// https://github.com/oscript-library/changelog-generate - для генерации истории изменений более простой. 
