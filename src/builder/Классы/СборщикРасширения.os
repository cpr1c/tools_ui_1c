...
Процедура ДобавитьИнформациюОСборкеВОбщийМодуль(ВКонфигурацию=Ложь) Экспорт
	...
	НастройкиПлагина.Вставить("ВариантСборки","Универсальные инструменты "+ВариантСборки.СуффиксСинонима);
	НастройкиПлагина.Вставить("ИмяФайлаСкачки",ВариантСборки.ИмяФайла+?(ВКонфигурацию,"cf","cfe"));
