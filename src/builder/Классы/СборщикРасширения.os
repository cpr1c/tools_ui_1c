...
Процедура ДобавитьИнформациюОСборкеВОбщийМодуль(Префикс) Экспорт
	...
	НастройкиПлагина.Вставить("ВариантСборки",Префикс+ВариантСборки.Имя);
...
Процедура ВыполнитьСборкуИсходников() Экспорт
	...
	ДобавитьИнформациюОСборкеВОбщийМодуль("Расширение");
