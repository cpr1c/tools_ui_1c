...
Процедура СобратьБинарныеФайлыПроекта(ОписаниеКонфигурации, КаталогИсходниковПоставки, КаталогПортативнойСборки)
	...
	УстановитьПроцедуруОписанияПодключаемыхМодулейПортативнойПоставки(ОписаниеКонфигурации,УспешноСобранныеИнструменты, КаталогИсходниковГлавнойОбработки);
...
Процедура УстановитьПроцедуруОписанияПодключаемыхМодулейПортативнойПоставки(ОписаниеКонфигурации, УспешноСобранныеИнструменты, КаталогИсходниковГлавнойОбработки)
...
Процедура СконвертироватьМодуль(ИмяФайлаМодуля, ИмяФормы, ОписаниеКонфигурации, ЭтоМодульФормы)
	Если Не ФС.ФайлСуществует(ИмяФайлаМодуля) Тогда
		Возврат;
	КонецЕсли;
