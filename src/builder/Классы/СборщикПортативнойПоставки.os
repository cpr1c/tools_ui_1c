...
Процедура ВыполнитьКонвертацию(КаталогПортативнойСборки) Экспорт
	...
	СтруктураПортативныхИнструментов.КаталогОбщихМодулей=ОбъединитьПути(СтруктураПортативныхИнструментов.КаталогИсходников,
		"ОбщиеМодули");
	СтруктураПортативныхИнструментов.КаталогКартинок=ОбъединитьПути(СтруктураПортативныхИнструментов.КаталогИсходников,
		"Картинки");
...
Процедура ПреобразоватьПодчиненныеЭлементыФормы(ЭлементыФормы, ОписанияКомандФормы, ПапкаФормы)
	...
	Для Каждого ОписаниеЭлемента Из ЭлементыФормы._Элементы Цикл
		...
		ПреобразоватьПодчиненныеЭлементыФормы(УзелОписания.Значение._Элементы["ChildItems"], ОписанияКомандФормы, ПапкаФормы);

		КоманднаяПанельФормыXML=УзелОписания.Значение._Элементы["AutoCommandBar"];

		Если КоманднаяПанельФормыXML<>Неопределено Тогда
			ПреобразоватьПодчиненныеЭлементыФормы(КоманднаяПанельФормыXML._Элементы["ChildItems"],ОписанияКомандФормы, ПапкаФормы);
		КонецЕсли;
...
Процедура ПреобразоватьОписаниеФормыДляПереводаВоВнешнююОбработку(ТекИнструмент, ИмяФормы)
	...
	ПреобразоватьПодчиненныеЭлементыФормы(ЭлементыXMLФорма._Элементы["ChildItems"],ОписанияКомандФормы, ПапкаФормы);
	...
	Для Каждого ТекИнструмент ИЗ СтруктураПортативныхИнструментов.Инструменты Цикл
		...
		Попытка
			...
			ОписаниеИнстурмента.ФайлОписания, 
				ОбъединитьПути(КаталогОбработокСборки, ОписаниеИнстурмента.Имя + ".epf"));
