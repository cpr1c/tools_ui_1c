...
Процедура СконвертироватьМодулиПортативнойПоставки(ОписаниеКонфигурации, 
	...
	Для Каждого ТекМодуль Из ОписаниеКонфигурации.ОбщиеМодули Цикл
		...
		Если ТекМодуль.Клиент Тогда
			...
			СконвертироватьМодуль(ИмяФайлаФормы, ИмяФормы, ОписаниеКонфигурации, Истина,,Истина);
...
Процедура СконвертироватьМодуль(ИмяФайлаМодуля, ИмяФормы, ОписаниеКонфигурации, ЭтоМодульФормы, ЭтоГлавнаяОбработка=Ложь, ЭтоОбщийМодуль=Ложь)
	Если Не ФС.ФайлСуществует(ИмяФайлаМодуля) Тогда
		Возврат;
	КонецЕсли;
