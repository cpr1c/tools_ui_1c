...
Перем ИмяРасширенияИнструментов;
...
Процедура Открыть(Парсер, Параметры) Экспорт
	...
	ИмяРасширенияИнструментов = "УниверсальныеИнструменты";
	Если ЗначениеЗаполнено(ВариантСборки.СуффиксИмени) Тогда
		ИмяРасширенияИнструментов = ИмяРасширенияИнструментов+"_"+ВариантСборки.СуффиксИмени;	
	КонецЕсли;
...
Процедура ПосетитьОбъявлениеМетода(Описание) Экспорт
	...
	ИначеЕсли НРег(Описание.Сигнатура.Имя) = "вариантпоставки" Тогда
		СтрокаВставки = "Возврат """+ВариантСборки.Имя+""";";
	ИначеЕсли НРег(Описание.Сигнатура.Имя) = "имяфайласкачивания" Тогда
		СтрокаВставки = "Возврат """ + ИмяФайлаСкачки + """;";
	ИначеЕсли НРег(Описание.Сигнатура.Имя) = "имярасширенияинструментов" Тогда	
		СтрокаВставки = "Возврат """ + ИмяРасширенияИнструментов + """;";
	КонецЕсли;
