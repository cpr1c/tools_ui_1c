...
Процедура ЗаполнитьТекстОписанияПодсистем(Тексты, Подсистемы) 
	Для Каждого ТекПодсистема Из Подсистемы Цикл
		Тексты.Добавить(СтрШаблон("ОписаниеПодсистем.Вставить(""%1"",""%2"");",ТекПодсистема.Имя, ТекПодсистема.Синоним));
...
Функция ТекстОписанияПодсистем() 
	...
	МассивТекстов.Добавить("ОписаниеПодсистем = Новый Структура;");
